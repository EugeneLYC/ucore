...
c0100653:	c7 45 f4 80 a3 10 c0 	movl   $0xc010a380,-0xc(%ebp)
    stab_end = __STAB_END__;
c010065a:	c7 45 f0 d0 94 11 c0 	movl   $0xc01194d0,-0x10(%ebp)
    stabstr = __STABSTR_BEGIN__;
c0100661:	c7 45 ec d1 94 11 c0 	movl   $0xc01194d1,-0x14(%ebp)
    stabstr_end = __STABSTR_END__;
c0100668:	c7 45 e8 bf cd 11 c0 	movl   $0xc011cdbf,-0x18(%ebp)
...
c0100a6e:	53                   	push   %ebx
c0100a6f:	83 ec 24             	sub    $0x24,%esp
}
...
c0100a72:	89 e8                	mov    %ebp,%eax
c0100a74:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    return ebp;
c0100a77:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
c0100a7d:	e8 d8 ff ff ff       	call   c0100a5a <read_eip>
c0100a82:	89 45 f0             	mov    %eax,-0x10(%ebp)
    for (int itr = 0; itr < STACKFRAME_DEPTH && ebp != 0; itr++) {
c0100a85:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
c0100a8c:	e9 89 00 00 00       	jmp    c0100b1a <print_stackframe+0xaf>
        cprintf("ebp = 0x%08x, eip = 0x%08x", ebp, eip);
c0100a91:	83 ec 04             	sub    $0x4,%esp
c0100a94:	ff 75 f0             	pushl  -0x10(%ebp)
c0100a97:	ff 75 f4             	pushl  -0xc(%ebp)
c0100a9a:	68 34 85 10 c0       	push   $0xc0108534
c0100a9f:	e8 de f7 ff ff       	call   c0100282 <cprintf>
c0100aa4:	83 c4 10             	add    $0x10,%esp
        uint32_t *ptr = (uint32_t *)(ebp + 2);
c0100aa7:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0100aaa:	83 c0 02             	add    $0x2,%eax
c0100aad:	89 45 e8             	mov    %eax,-0x18(%ebp)
        cprintf("arg = 0x%08x, 0x%08x, 0x%08x, 0x%08x", *(ptr), *(ptr+1), *(ptr+2), *(ptr+3));
c0100ab0:	8b 45 e8             	mov    -0x18(%ebp),%eax
c0100ab3:	83 c0 0c             	add    $0xc,%eax
c0100ab6:	8b 18                	mov    (%eax),%ebx
c0100ab8:	8b 45 e8             	mov    -0x18(%ebp),%eax
c0100abb:	83 c0 08             	add    $0x8,%eax
c0100abe:	8b 08                	mov    (%eax),%ecx
c0100ac0:	8b 45 e8             	mov    -0x18(%ebp),%eax
c0100ac3:	83 c0 04             	add    $0x4,%eax
c0100ac6:	8b 10                	mov    (%eax),%edx
c0100ac8:	8b 45 e8             	mov    -0x18(%ebp),%eax
c0100acb:	8b 00                	mov    (%eax),%eax
c0100acd:	83 ec 0c             	sub    $0xc,%esp
c0100ad0:	53                   	push   %ebx
c0100ad1:	51                   	push   %ecx
c0100ad2:	52                   	push   %edx
c0100ad3:	50                   	push   %eax
c0100ad4:	68 50 85 10 c0       	push   $0xc0108550
c0100ad9:	e8 a4 f7 ff ff       	call   c0100282 <cprintf>
c0100ade:	83 c4 20             	add    $0x20,%esp
        cprintf("\n");
c0100ae1:	83 ec 0c             	sub    $0xc,%esp
c0100ae4:	68 75 85 10 c0       	push   $0xc0108575
c0100ae9:	e8 94 f7 ff ff       	call   c0100282 <cprintf>
c0100aee:	83 c4 10             	add    $0x10,%esp
        print_debuginfo(eip - 1);
c0100af1:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0100af4:	83 e8 01             	sub    $0x1,%eax
c0100af7:	83 ec 0c             	sub    $0xc,%esp
c0100afa:	50                   	push   %eax
c0100afb:	e8 be fe ff ff       	call   c01009be <print_debuginfo>
c0100b00:	83 c4 10             	add    $0x10,%esp
...
c0100b0b:	89 45 f0             	mov    %eax,-0x10(%ebp)
        ebp = ((uint32_t *)ebp)[0];
c0100b0e:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0100b11:	8b 00                	mov    (%eax),%eax
c0100b13:	89 45 f4             	mov    %eax,-0xc(%ebp)
      *           NOTICE: the calling funciton's return addr eip  = ss:[ebp+4]
      *                   the calling funciton's ebp = ss:[ebp]
      */
    uint32_t ebp = read_ebp();
    uint32_t eip = read_eip();
    for (int itr = 0; itr < STACKFRAME_DEPTH && ebp != 0; itr++) {
c0100b16:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
c0100b1a:	83 7d ec 13          	cmpl   $0x13,-0x14(%ebp)
c0100b1e:	7f 0a                	jg     c0100b2a <print_stackframe+0xbf>
c0100b20:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
c0100b24:	0f 85 67 ff ff ff    	jne    c0100a91 <print_stackframe+0x26>
...
c0100b2a:	90                   	nop
c0100b2b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c0100b2e:	c9                   	leave  
c0100b2f:	c3                   	ret    
...
c0100b62:	68 f8 85 10 c0       	push   $0xc01085f8
...
c0100b88:	68 fd 85 10 c0       	push   $0xc01085fd
...
c0100bd0:	68 f8 85 10 c0       	push   $0xc01085f8
...
c0100c88:	68 1b 86 10 c0       	push   $0xc010861b
...
c0100cd9:	68 81 86 10 c0       	push   $0xc0108681
...
c0100d44:	68 85 86 10 c0       	push   $0xc0108685
...
c0100e1c:	0f b7 04 85 90 86 10 	movzwl -0x3fef7970(,%eax,4),%eax
c0100e23:	c0 
...
c0100fa9:	68 98 86 10 c0       	push   $0xc0108698
c0100fae:	68 db 86 10 c0       	push   $0xc01086db
c0100fb3:	6a 7d                	push   $0x7d
c0100fb5:	68 f0 86 10 c0       	push   $0xc01086f0
...
c010109e:	68 02 87 10 c0       	push   $0xc0108702
...
c01011a3:	68 20 87 10 c0       	push   $0xc0108720
c01011a8:	68 db 86 10 c0       	push   $0xc01086db
c01011ad:	68 9f 00 00 00       	push   $0x9f
c01011b2:	68 f0 86 10 c0       	push   $0xc01086f0
...
c01011d4:	68 48 87 10 c0       	push   $0xc0108748
c01011d9:	68 db 86 10 c0       	push   $0xc01086db
c01011de:	68 a0 00 00 00       	push   $0xa0
c01011e3:	68 f0 86 10 c0       	push   $0xc01086f0
...
c01011f7:	0f b7 04 85 90 86 10 	movzwl -0x3fef7970(,%eax,4),%eax
c01011fe:	c0 
...
c010120d:	0f b7 04 85 92 86 10 	movzwl -0x3fef796e(,%eax,4),%eax
c0101214:	c0 
...
c01013cd:	68 20 87 10 c0       	push   $0xc0108720
c01013d2:	68 db 86 10 c0       	push   $0xc01086db
c01013d7:	68 bc 00 00 00       	push   $0xbc
c01013dc:	68 f0 86 10 c0       	push   $0xc01086f0
...
c01013fe:	68 48 87 10 c0       	push   $0xc0108748
c0101403:	68 db 86 10 c0       	push   $0xc01086db
c0101408:	68 bd 00 00 00       	push   $0xbd
c010140d:	68 f0 86 10 c0       	push   $0xc01086f0
...
c0101421:	0f b7 04 85 90 86 10 	movzwl -0x3fef7970(,%eax,4),%eax
c0101428:	c0 
...
c0101437:	0f b7 04 85 92 86 10 	movzwl -0x3fef796e(,%eax,4),%eax
c010143e:	c0 
...
c0101606:	68 82 87 10 c0       	push   $0xc0108782
...
c0101dba:	68 9d 87 10 c0       	push   $0xc010879d
...
c0101e34:	68 a9 87 10 c0       	push   $0xc01087a9
...
c01021ec:	8b 04 85 c0 8b 10 c0 	mov    -0x3fef7440(,%eax,4),%eax
...
c0102201:	b8 ea 87 10 c0       	mov    $0xc01087ea,%eax
c0102206:	eb 05                	jmp    c010220d <trapname+0x2f>
    }
    return "(unknown trap)";
c0102208:	b8 fd 87 10 c0       	mov    $0xc01087fd,%eax
}
c010220d:	5d                   	pop    %ebp
c010220e:	c3                   	ret    
...
c0102231:	68 3e 88 10 c0       	push   $0xc010883e
...
c010225b:	68 4f 88 10 c0       	push   $0xc010884f
...
c0102276:	68 62 88 10 c0       	push   $0xc0108862
...
c0102291:	68 75 88 10 c0       	push   $0xc0108875
...
c01022ac:	68 88 88 10 c0       	push   $0xc0108888
...
c01022d8:	68 9b 88 10 c0       	push   $0xc010889b
...
c01022ef:	68 ad 88 10 c0       	push   $0xc01088ad
...
c0102306:	68 bc 88 10 c0       	push   $0xc01088bc
...
c0102321:	68 cb 88 10 c0       	push   $0xc01088cb
...
c0102338:	68 de 88 10 c0       	push   $0xc01088de
...
c0102380:	68 ed 88 10 c0       	push   $0xc01088ed
...
c01023ae:	68 f1 88 10 c0       	push   $0xc01088f1
...
c01023d7:	68 fa 88 10 c0       	push   $0xc01088fa
...
c01023f2:	68 09 89 10 c0       	push   $0xc0108909
...
c0102411:	68 1c 89 10 c0       	push   $0xc010891c
...
c0102428:	68 2b 89 10 c0       	push   $0xc010892b
...
c010243f:	68 3a 89 10 c0       	push   $0xc010893a
...
c0102456:	68 49 89 10 c0       	push   $0xc0108949
...
c010246d:	68 58 89 10 c0       	push   $0xc0108958
...
c0102484:	68 67 89 10 c0       	push   $0xc0108967
...
c010249b:	68 76 89 10 c0       	push   $0xc0108976
...
c01024b2:	68 85 89 10 c0       	push   $0xc0108985
...
c01024d6:	bb 94 89 10 c0       	mov    $0xc0108994,%ebx
c01024db:	eb 05                	jmp    c01024e2 <print_pgfault+0x20>
c01024dd:	bb a5 89 10 c0       	mov    $0xc01089a5,%ebx
            (tf->tf_err & 4) ? 'U' : 'K',
            (tf->tf_err & 2) ? 'W' : 'R',
...
c0102524:	68 b4 89 10 c0       	push   $0xc01089b4
...
c010257b:	68 d7 89 10 c0       	push   $0xc01089d7
c0102580:	68 a5 00 00 00       	push   $0xa5
c0102585:	68 ee 89 10 c0       	push   $0xc01089ee
...
c0102612:	68 ff 89 10 c0       	push   $0xc01089ff
c0102617:	68 b5 00 00 00       	push   $0xb5
c010261c:	68 ee 89 10 c0       	push   $0xc01089ee
...
c0102675:	68 1a 8a 10 c0       	push   $0xc0108a1a
...
c0102699:	68 2c 8a 10 c0       	push   $0xc0108a2c
...
c01026ab:	68 3b 8a 10 c0       	push   $0xc0108a3b
c01026b0:	68 d3 00 00 00       	push   $0xd3
c01026b5:	68 ee 89 10 c0       	push   $0xc01089ee
...
c01026e1:	68 4b 8a 10 c0       	push   $0xc0108a4b
c01026e6:	68 dd 00 00 00       	push   $0xdd
c01026eb:	68 ee 89 10 c0       	push   $0xc01089ee
...
c01031c2:	68 10 8c 10 c0       	push   $0xc0108c10
c01031c7:	6a 5b                	push   $0x5b
c01031c9:	68 2f 8c 10 c0       	push   $0xc0108c2f
...
c0103380:	68 3d 8c 10 c0       	push   $0xc0108c3d
c0103385:	68 5b 8c 10 c0       	push   $0xc0108c5b
c010338a:	6a 67                	push   $0x67
c010338c:	68 70 8c 10 c0       	push   $0xc0108c70
...
c01033a6:	68 80 8c 10 c0       	push   $0xc0108c80
c01033ab:	68 5b 8c 10 c0       	push   $0xc0108c5b
c01033b0:	6a 68                	push   $0x68
c01033b2:	68 70 8c 10 c0       	push   $0xc0108c70
...
c01033cc:	68 9f 8c 10 c0       	push   $0xc0108c9f
c01033d1:	68 5b 8c 10 c0       	push   $0xc0108c5b
c01033d6:	6a 69                	push   $0x69
c01033d8:	68 70 8c 10 c0       	push   $0xc0108c70
...
c01033fb:	68 bd 8c 10 c0       	push   $0xc0108cbd
c0103400:	68 5b 8c 10 c0       	push   $0xc0108c5b
c0103405:	6a 70                	push   $0x70
c0103407:	68 70 8c 10 c0       	push   $0xc0108c70
...
c01035b4:	68 dc 8c 10 c0       	push   $0xc0108cdc
c01035b9:	68 5b 8c 10 c0       	push   $0xc0108c5b
c01035be:	68 a9 00 00 00       	push   $0xa9
c01035c3:	68 70 8c 10 c0       	push   $0xc0108c70
c01035c8:	e8 1b ce ff ff       	call   c01003e8 <__panic>

    cprintf("check_vmm() succeeded.\n");
c01035cd:	83 ec 0c             	sub    $0xc,%esp
c01035d0:	68 03 8d 10 c0       	push   $0xc0108d03
...
c01035fc:	68 1b 8d 10 c0       	push   $0xc0108d1b
c0103601:	68 5b 8c 10 c0       	push   $0xc0108c5b
c0103606:	68 b3 00 00 00       	push   $0xb3
c010360b:	68 70 8c 10 c0       	push   $0xc0108c70
...
c0103664:	68 26 8d 10 c0       	push   $0xc0108d26
c0103669:	68 5b 8c 10 c0       	push   $0xc0108c5b
c010366e:	68 ba 00 00 00       	push   $0xba
c0103673:	68 70 8c 10 c0       	push   $0xc0108c70
...
c01036d4:	68 26 8d 10 c0       	push   $0xc0108d26
c01036d9:	68 5b 8c 10 c0       	push   $0xc0108c5b
c01036de:	68 c0 00 00 00       	push   $0xc0
c01036e3:	68 70 8c 10 c0       	push   $0xc0108c70
...
c010372d:	68 32 8d 10 c0       	push   $0xc0108d32
c0103732:	68 5b 8c 10 c0       	push   $0xc0108c5b
c0103737:	68 c7 00 00 00       	push   $0xc7
c010373c:	68 70 8c 10 c0       	push   $0xc0108c70
...
c010377a:	68 4c 8d 10 c0       	push   $0xc0108d4c
c010377f:	68 5b 8c 10 c0       	push   $0xc0108c5b
c0103784:	68 c9 00 00 00       	push   $0xc9
c0103789:	68 70 8c 10 c0       	push   $0xc0108c70
...
c01037d9:	68 81 8d 10 c0       	push   $0xc0108d81
c01037de:	68 5b 8c 10 c0       	push   $0xc0108c5b
c01037e3:	68 cf 00 00 00       	push   $0xcf
c01037e8:	68 70 8c 10 c0       	push   $0xc0108c70
...
c0103810:	68 8e 8d 10 c0       	push   $0xc0108d8e
c0103815:	68 5b 8c 10 c0       	push   $0xc0108c5b
c010381a:	68 d1 00 00 00       	push   $0xd1
c010381f:	68 70 8c 10 c0       	push   $0xc0108c70
...
c0103847:	68 9b 8d 10 c0       	push   $0xc0108d9b
c010384c:	68 5b 8c 10 c0       	push   $0xc0108c5b
c0103851:	68 d3 00 00 00       	push   $0xd3
c0103856:	68 70 8c 10 c0       	push   $0xc0108c70
...
c010387e:	68 a8 8d 10 c0       	push   $0xc0108da8
c0103883:	68 5b 8c 10 c0       	push   $0xc0108c5b
c0103888:	68 d5 00 00 00       	push   $0xd5
c010388d:	68 70 8c 10 c0       	push   $0xc0108c70
...
c01038b5:	68 b5 8d 10 c0       	push   $0xc0108db5
c01038ba:	68 5b 8c 10 c0       	push   $0xc0108c5b
c01038bf:	68 d7 00 00 00       	push   $0xd7
c01038c4:	68 70 8c 10 c0       	push   $0xc0108c70
...
c01038eb:	68 c4 8d 10 c0       	push   $0xc0108dc4
c01038f0:	68 5b 8c 10 c0       	push   $0xc0108c5b
c01038f5:	68 d9 00 00 00       	push   $0xd9
c01038fa:	68 70 8c 10 c0       	push   $0xc0108c70
...
c0103921:	68 f4 8d 10 c0       	push   $0xc0108df4
c0103926:	68 5b 8c 10 c0       	push   $0xc0108c5b
c010392b:	68 da 00 00 00       	push   $0xda
c0103930:	68 70 8c 10 c0       	push   $0xc0108c70
...
c0103986:	68 24 8e 10 c0       	push   $0xc0108e24
...
c0103999:	68 49 8e 10 c0       	push   $0xc0108e49
c010399e:	68 5b 8c 10 c0       	push   $0xc0108c5b
c01039a3:	68 e2 00 00 00       	push   $0xe2
c01039a8:	68 70 8c 10 c0       	push   $0xc0108c70
...
c01039d4:	68 dc 8c 10 c0       	push   $0xc0108cdc
c01039d9:	68 5b 8c 10 c0       	push   $0xc0108c5b
c01039de:	68 e7 00 00 00       	push   $0xe7
c01039e3:	68 70 8c 10 c0       	push   $0xc0108c70
c01039e8:	e8 fb c9 ff ff       	call   c01003e8 <__panic>

    cprintf("check_vma_struct() succeeded!\n");
c01039ed:	83 ec 0c             	sub    $0xc,%esp
c01039f0:	68 60 8e 10 c0       	push   $0xc0108e60
...
c0103a21:	68 7f 8e 10 c0       	push   $0xc0108e7f
c0103a26:	68 5b 8c 10 c0       	push   $0xc0108c5b
c0103a2b:	68 f4 00 00 00       	push   $0xf4
c0103a30:	68 70 8c 10 c0       	push   $0xc0108c70
...
c0103a60:	68 97 8e 10 c0       	push   $0xc0108e97
c0103a65:	68 5b 8c 10 c0       	push   $0xc0108c5b
c0103a6a:	68 f8 00 00 00       	push   $0xf8
c0103a6f:	68 70 8c 10 c0       	push   $0xc0108c70
...
c0103a96:	68 26 8d 10 c0       	push   $0xc0108d26
c0103a9b:	68 5b 8c 10 c0       	push   $0xc0108c5b
c0103aa0:	68 fb 00 00 00       	push   $0xfb
c0103aa5:	68 70 8c 10 c0       	push   $0xc0108c70
...
c0103add:	68 a5 8e 10 c0       	push   $0xc0108ea5
c0103ae2:	68 5b 8c 10 c0       	push   $0xc0108c5b
c0103ae7:	68 00 01 00 00       	push   $0x100
c0103aec:	68 70 8c 10 c0       	push   $0xc0108c70
...
c0103b4f:	68 bf 8e 10 c0       	push   $0xc0108ebf
c0103b54:	68 5b 8c 10 c0       	push   $0xc0108c5b
c0103b59:	68 0a 01 00 00       	push   $0x10a
c0103b5e:	68 70 8c 10 c0       	push   $0xc0108c70
...
c0103bd9:	68 dc 8c 10 c0       	push   $0xc0108cdc
c0103bde:	68 5b 8c 10 c0       	push   $0xc0108c5b
c0103be3:	68 14 01 00 00       	push   $0x114
c0103be8:	68 70 8c 10 c0       	push   $0xc0108c70
c0103bed:	e8 f6 c7 ff ff       	call   c01003e8 <__panic>

    cprintf("check_pgfault() succeeded!\n");
c0103bf2:	83 ec 0c             	sub    $0xc,%esp
c0103bf5:	68 c8 8e 10 c0       	push   $0xc0108ec8
...
c0103c47:	68 e4 8e 10 c0       	push   $0xc0108ee4
...
c0103c78:	68 14 8f 10 c0       	push   $0xc0108f14
...
c0103c8d:	68 74 8f 10 c0       	push   $0xc0108f74
...
c0103caf:	68 ac 8f 10 c0       	push   $0xc0108fac
...
c0103d1c:	68 0f 90 10 c0       	push   $0xc010900f
...
c0103d5a:	68 30 90 10 c0       	push   $0xc0109030
...
c0103d9d:	68 57 90 10 c0       	push   $0xc0109057
...
c0103ded:	68 78 90 10 c0       	push   $0xc0109078
...
c0103e5e:	68 a0 90 10 c0       	push   $0xc01090a0
c0103e63:	68 be 90 10 c0       	push   $0xc01090be
c0103e68:	6a 32                	push   $0x32
c0103e6a:	68 d3 90 10 c0       	push   $0xc01090d3
...
c0103ee1:	68 e7 90 10 c0       	push   $0xc01090e7
c0103ee6:	68 be 90 10 c0       	push   $0xc01090be
c0103eeb:	6a 41                	push   $0x41
c0103eed:	68 d3 90 10 c0       	push   $0xc01090d3
...
c0103efd:	68 f4 90 10 c0       	push   $0xc01090f4
c0103f02:	68 be 90 10 c0       	push   $0xc01090be
c0103f07:	6a 42                	push   $0x42
c0103f09:	68 d3 90 10 c0       	push   $0xc01090d3
...
c0103f23:	68 ff 90 10 c0       	push   $0xc01090ff
c0103f28:	68 be 90 10 c0       	push   $0xc01090be
c0103f2d:	6a 49                	push   $0x49
c0103f2f:	68 d3 90 10 c0       	push   $0xc01090d3
...
c0103f70:	68 08 91 10 c0       	push   $0xc0109108
c0103f75:	68 be 90 10 c0       	push   $0xc01090be
c0103f7a:	6a 4c                	push   $0x4c
c0103f7c:	68 d3 90 10 c0       	push   $0xc01090d3
...
c0103f9e:	68 14 91 10 c0       	push   $0xc0109114
...
c0103fbd:	68 3a 91 10 c0       	push   $0xc010913a
c0103fc2:	68 be 90 10 c0       	push   $0xc01090be
c0103fc7:	6a 55                	push   $0x55
c0103fc9:	68 d3 90 10 c0       	push   $0xc01090d3
c0103fce:	e8 15 c4 ff ff       	call   c01003e8 <__panic>
    cprintf("write Virt Page a in fifo_check_swap\n");
c0103fd3:	83 ec 0c             	sub    $0xc,%esp
c0103fd6:	68 4c 91 10 c0       	push   $0xc010914c
...
c0103ff5:	68 3a 91 10 c0       	push   $0xc010913a
c0103ffa:	68 be 90 10 c0       	push   $0xc01090be
c0103fff:	6a 58                	push   $0x58
c0104001:	68 d3 90 10 c0       	push   $0xc01090d3
c0104006:	e8 dd c3 ff ff       	call   c01003e8 <__panic>
    cprintf("write Virt Page d in fifo_check_swap\n");
c010400b:	83 ec 0c             	sub    $0xc,%esp
c010400e:	68 74 91 10 c0       	push   $0xc0109174
...
c010402d:	68 3a 91 10 c0       	push   $0xc010913a
c0104032:	68 be 90 10 c0       	push   $0xc01090be
c0104037:	6a 5b                	push   $0x5b
c0104039:	68 d3 90 10 c0       	push   $0xc01090d3
c010403e:	e8 a5 c3 ff ff       	call   c01003e8 <__panic>
    cprintf("write Virt Page b in fifo_check_swap\n");
c0104043:	83 ec 0c             	sub    $0xc,%esp
c0104046:	68 9c 91 10 c0       	push   $0xc010919c
...
c0104065:	68 3a 91 10 c0       	push   $0xc010913a
c010406a:	68 be 90 10 c0       	push   $0xc01090be
c010406f:	6a 5e                	push   $0x5e
c0104071:	68 d3 90 10 c0       	push   $0xc01090d3
c0104076:	e8 6d c3 ff ff       	call   c01003e8 <__panic>
    cprintf("write Virt Page e in fifo_check_swap\n");
c010407b:	83 ec 0c             	sub    $0xc,%esp
c010407e:	68 c4 91 10 c0       	push   $0xc01091c4
...
c010409d:	68 ea 91 10 c0       	push   $0xc01091ea
c01040a2:	68 be 90 10 c0       	push   $0xc01090be
c01040a7:	6a 61                	push   $0x61
c01040a9:	68 d3 90 10 c0       	push   $0xc01090d3
c01040ae:	e8 35 c3 ff ff       	call   c01003e8 <__panic>
    cprintf("write Virt Page b in fifo_check_swap\n");
c01040b3:	83 ec 0c             	sub    $0xc,%esp
c01040b6:	68 9c 91 10 c0       	push   $0xc010919c
...
c01040d5:	68 ea 91 10 c0       	push   $0xc01091ea
c01040da:	68 be 90 10 c0       	push   $0xc01090be
c01040df:	6a 64                	push   $0x64
c01040e1:	68 d3 90 10 c0       	push   $0xc01090d3
c01040e6:	e8 fd c2 ff ff       	call   c01003e8 <__panic>
    cprintf("write Virt Page a in fifo_check_swap\n");
c01040eb:	83 ec 0c             	sub    $0xc,%esp
c01040ee:	68 4c 91 10 c0       	push   $0xc010914c
...
c010410d:	68 f9 91 10 c0       	push   $0xc01091f9
c0104112:	68 be 90 10 c0       	push   $0xc01090be
c0104117:	6a 67                	push   $0x67
c0104119:	68 d3 90 10 c0       	push   $0xc01090d3
c010411e:	e8 c5 c2 ff ff       	call   c01003e8 <__panic>
    cprintf("write Virt Page b in fifo_check_swap\n");
c0104123:	83 ec 0c             	sub    $0xc,%esp
c0104126:	68 9c 91 10 c0       	push   $0xc010919c
...
c0104145:	68 08 92 10 c0       	push   $0xc0109208
c010414a:	68 be 90 10 c0       	push   $0xc01090be
c010414f:	6a 6a                	push   $0x6a
c0104151:	68 d3 90 10 c0       	push   $0xc01090d3
c0104156:	e8 8d c2 ff ff       	call   c01003e8 <__panic>
    cprintf("write Virt Page c in fifo_check_swap\n");
c010415b:	83 ec 0c             	sub    $0xc,%esp
c010415e:	68 14 91 10 c0       	push   $0xc0109114
...
c010417d:	68 17 92 10 c0       	push   $0xc0109217
c0104182:	68 be 90 10 c0       	push   $0xc01090be
c0104187:	6a 6d                	push   $0x6d
c0104189:	68 d3 90 10 c0       	push   $0xc01090d3
c010418e:	e8 55 c2 ff ff       	call   c01003e8 <__panic>
    cprintf("write Virt Page d in fifo_check_swap\n");
c0104193:	83 ec 0c             	sub    $0xc,%esp
c0104196:	68 74 91 10 c0       	push   $0xc0109174
...
c01041b5:	68 26 92 10 c0       	push   $0xc0109226
c01041ba:	68 be 90 10 c0       	push   $0xc01090be
c01041bf:	6a 70                	push   $0x70
c01041c1:	68 d3 90 10 c0       	push   $0xc01090d3
c01041c6:	e8 1d c2 ff ff       	call   c01003e8 <__panic>
    cprintf("write Virt Page e in fifo_check_swap\n");
c01041cb:	83 ec 0c             	sub    $0xc,%esp
c01041ce:	68 c4 91 10 c0       	push   $0xc01091c4
...
c01041ed:	68 35 92 10 c0       	push   $0xc0109235
c01041f2:	68 be 90 10 c0       	push   $0xc01090be
c01041f7:	6a 73                	push   $0x73
c01041f9:	68 d3 90 10 c0       	push   $0xc01090d3
c01041fe:	e8 e5 c1 ff ff       	call   c01003e8 <__panic>
    cprintf("write Virt Page a in fifo_check_swap\n");
c0104203:	83 ec 0c             	sub    $0xc,%esp
c0104206:	68 4c 91 10 c0       	push   $0xc010914c
...
c010421f:	68 48 92 10 c0       	push   $0xc0109248
c0104224:	68 be 90 10 c0       	push   $0xc01090be
c0104229:	6a 75                	push   $0x75
c010422b:	68 d3 90 10 c0       	push   $0xc01090d3
...
c0104247:	68 69 92 10 c0       	push   $0xc0109269
c010424c:	68 be 90 10 c0       	push   $0xc01090be
c0104251:	6a 77                	push   $0x77
c0104253:	68 d3 90 10 c0       	push   $0xc01090d3
...
c010429c:	68 8c 92 10 c0       	push   $0xc010928c
c01042a1:	6a 5b                	push   $0x5b
c01042a3:	68 ab 92 10 c0       	push   $0xc01092ab
...
c01042d2:	68 bc 92 10 c0       	push   $0xc01092bc
c01042d7:	6a 6d                	push   $0x6d
c01042d9:	68 ab 92 10 c0       	push   $0xc01092ab
...
c0104322:	68 dd 92 10 c0       	push   $0xc01092dd
c0104327:	6a 25                	push   $0x25
c0104329:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104365:	68 07 93 10 c0       	push   $0xc0109307
...
c010442c:	68 1c 93 10 c0       	push   $0xc010931c
...
c010446d:	68 49 93 10 c0       	push   $0xc0109349
c0104472:	68 5e 93 10 c0       	push   $0xc010935e
c0104477:	6a 65                	push   $0x65
c0104479:	68 f8 92 10 c0       	push   $0xc01092f8
...
c01044a9:	68 73 93 10 c0       	push   $0xc0109373
...
c01044e4:	68 8c 93 10 c0       	push   $0xc010938c
...
c010455e:	68 cc 93 10 c0       	push   $0xc01093cc
c0104563:	68 5e 93 10 c0       	push   $0xc010935e
c0104568:	6a 7b                	push   $0x7b
c010456a:	68 f8 92 10 c0       	push   $0xc01092f8
...
c01045b1:	68 d9 93 10 c0       	push   $0xc01093d9
c01045b6:	68 5e 93 10 c0       	push   $0xc010935e
c01045bb:	68 83 00 00 00       	push   $0x83
c01045c0:	68 f8 92 10 c0       	push   $0xc01092f8
...
c01045d9:	68 e0 93 10 c0       	push   $0xc01093e0
...
c010460d:	68 1e 94 10 c0       	push   $0xc010941e
c0104612:	68 5e 93 10 c0       	push   $0xc010935e
c0104617:	68 90 00 00 00       	push   $0x90
c010461c:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104638:	68 1e 94 10 c0       	push   $0xc010941e
c010463d:	68 5e 93 10 c0       	push   $0xc010935e
c0104642:	68 92 00 00 00       	push   $0x92
c0104647:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104663:	68 2d 94 10 c0       	push   $0xc010942d
c0104668:	68 5e 93 10 c0       	push   $0xc010935e
c010466d:	68 94 00 00 00       	push   $0x94
c0104672:	68 f8 92 10 c0       	push   $0xc01092f8
...
c010468e:	68 2d 94 10 c0       	push   $0xc010942d
c0104693:	68 5e 93 10 c0       	push   $0xc010935e
c0104698:	68 96 00 00 00       	push   $0x96
c010469d:	68 f8 92 10 c0       	push   $0xc01092f8
...
c01046b9:	68 3c 94 10 c0       	push   $0xc010943c
c01046be:	68 5e 93 10 c0       	push   $0xc010935e
c01046c3:	68 98 00 00 00       	push   $0x98
c01046c8:	68 f8 92 10 c0       	push   $0xc01092f8
...
c01046e4:	68 3c 94 10 c0       	push   $0xc010943c
c01046e9:	68 5e 93 10 c0       	push   $0xc010935e
c01046ee:	68 9a 00 00 00       	push   $0x9a
c01046f3:	68 f8 92 10 c0       	push   $0xc01092f8
...
c010470f:	68 4b 94 10 c0       	push   $0xc010944b
c0104714:	68 5e 93 10 c0       	push   $0xc010935e
c0104719:	68 9c 00 00 00       	push   $0x9c
c010471e:	68 f8 92 10 c0       	push   $0xc01092f8
...
c010473a:	68 4b 94 10 c0       	push   $0xc010944b
c010473f:	68 5e 93 10 c0       	push   $0xc010935e
c0104744:	68 9e 00 00 00       	push   $0x9e
c0104749:	68 f8 92 10 c0       	push   $0xc01092f8
...
c01047c0:	68 5a 94 10 c0       	push   $0xc010945a
c01047c5:	68 5e 93 10 c0       	push   $0xc010935e
c01047ca:	68 b9 00 00 00       	push   $0xb9
c01047cf:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104811:	68 6a 94 10 c0       	push   $0xc010946a
c0104816:	68 5e 93 10 c0       	push   $0xc010935e
c010481b:	68 bc 00 00 00       	push   $0xbc
c0104820:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104833:	68 84 94 10 c0       	push   $0xc0109484
...
c010484e:	68 aa 94 10 c0       	push   $0xc01094aa
c0104853:	68 5e 93 10 c0       	push   $0xc010935e
c0104858:	68 c1 00 00 00       	push   $0xc1
c010485d:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104870:	68 b5 94 10 c0       	push   $0xc01094b5
c0104875:	68 5e 93 10 c0       	push   $0xc010935e
c010487a:	68 c4 00 00 00       	push   $0xc4
c010487f:	68 f8 92 10 c0       	push   $0xc01092f8
...
c01048af:	68 cd 94 10 c0       	push   $0xc01094cd
c01048b4:	68 5e 93 10 c0       	push   $0xc010935e
c01048b9:	68 c9 00 00 00       	push   $0xc9
c01048be:	68 f8 92 10 c0       	push   $0xc01092f8
...
c01048e8:	68 db 94 10 c0       	push   $0xc01094db
c01048ed:	68 5e 93 10 c0       	push   $0xc010935e
c01048f2:	68 cc 00 00 00       	push   $0xcc
c01048f7:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104915:	68 e8 94 10 c0       	push   $0xc01094e8
...
c010494b:	68 1c 95 10 c0       	push   $0xc010951c
c0104950:	68 5e 93 10 c0       	push   $0xc010935e
c0104955:	68 d4 00 00 00       	push   $0xd4
c010495a:	68 f8 92 10 c0       	push   $0xc01092f8
c010495f:	e8 84 ba ff ff       	call   c01003e8 <__panic>
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
c0104964:	83 ec 0c             	sub    $0xc,%esp
c0104967:	68 30 95 10 c0       	push   $0xc0109530
...
c01049a7:	68 54 95 10 c0       	push   $0xc0109554
c01049ac:	68 5e 93 10 c0       	push   $0xc010935e
c01049b1:	68 d9 00 00 00       	push   $0xd9
c01049b6:	68 f8 92 10 c0       	push   $0xc01092f8
...
c01049f3:	68 68 95 10 c0       	push   $0xc0109568
c01049f8:	68 5e 93 10 c0       	push   $0xc010935e
c01049fd:	68 da 00 00 00       	push   $0xda
c0104a02:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104a60:	68 83 95 10 c0       	push   $0xc0109583
c0104a65:	68 5e 93 10 c0       	push   $0xc010935e
c0104a6a:	68 de 00 00 00       	push   $0xde
c0104a6f:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104ac0:	68 9c 95 10 c0       	push   $0xc010959c
c0104ac5:	68 5e 93 10 c0       	push   $0xc010935e
c0104aca:	68 e7 00 00 00       	push   $0xe7
c0104acf:	68 f8 92 10 c0       	push   $0xc01092f8
c0104ad4:	e8 0f b9 ff ff       	call   c01003e8 <__panic>
     
     cprintf("set up init env for check_swap begin!\n");
c0104ad9:	83 ec 0c             	sub    $0xc,%esp
c0104adc:	68 c0 95 10 c0       	push   $0xc01095c0
...
c0104b01:	68 e7 95 10 c0       	push   $0xc01095e7
c0104b06:	68 5e 93 10 c0       	push   $0xc010935e
c0104b0b:	68 f0 00 00 00       	push   $0xf0
c0104b10:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104b9d:	68 f4 95 10 c0       	push   $0xc01095f4
c0104ba2:	68 5e 93 10 c0       	push   $0xc010935e
c0104ba7:	68 f8 00 00 00       	push   $0xf8
c0104bac:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104bde:	68 0c 96 10 c0       	push   $0xc010960c
c0104be3:	68 5e 93 10 c0       	push   $0xc010935e
c0104be8:	68 f9 00 00 00       	push   $0xf9
c0104bed:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104c0a:	68 34 96 10 c0       	push   $0xc0109634
c0104c0f:	68 5e 93 10 c0       	push   $0xc010935e
c0104c14:	68 fa 00 00 00       	push   $0xfa
c0104c19:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104c34:	68 50 96 10 c0       	push   $0xc0109650
...
c0104c4f:	68 76 96 10 c0       	push   $0xc0109676
c0104c54:	68 5e 93 10 c0       	push   $0xc010935e
c0104c59:	68 ff 00 00 00       	push   $0xff
c0104c5e:	68 f8 92 10 c0       	push   $0xc01092f8
...
c0104d01:	68 7d 96 10 c0       	push   $0xc010967d
...
c0104d11:	68 97 96 10 c0       	push   $0xc0109697
...
c0104d99:	68 b0 96 10 c0       	push   $0xc01096b0
c0104d9e:	68 b6 96 10 c0       	push   $0xc01096b6
c0104da3:	6a 6d                	push   $0x6d
c0104da5:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0104de3:	68 e1 96 10 c0       	push   $0xc01096e1
c0104de8:	68 b6 96 10 c0       	push   $0xc01096b6
c0104ded:	6a 70                	push   $0x70
c0104def:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0104ebe:	68 b0 96 10 c0       	push   $0xc01096b0
c0104ec3:	68 b6 96 10 c0       	push   $0xc01096b6
c0104ec8:	6a 7c                	push   $0x7c
c0104eca:	68 cb 96 10 c0       	push   $0xc01096cb
...
c010502f:	68 b0 96 10 c0       	push   $0xc01096b0
c0105034:	68 b6 96 10 c0       	push   $0xc01096b6
c0105039:	68 9a 00 00 00       	push   $0x9a
c010503e:	68 cb 96 10 c0       	push   $0xc01096cb
...
c01050ab:	68 f4 96 10 c0       	push   $0xc01096f4
c01050b0:	68 b6 96 10 c0       	push   $0xc01096b6
c01050b5:	68 9d 00 00 00       	push   $0x9d
c01050ba:	68 cb 96 10 c0       	push   $0xc01096cb
...
c010528b:	68 19 97 10 c0       	push   $0xc0109719
c0105290:	68 b6 96 10 c0       	push   $0xc01096b6
c0105295:	68 b9 00 00 00       	push   $0xb9
c010529a:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105342:	68 34 97 10 c0       	push   $0xc0109734
c0105347:	68 b6 96 10 c0       	push   $0xc01096b6
c010534c:	68 ca 00 00 00       	push   $0xca
c0105351:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105371:	68 50 97 10 c0       	push   $0xc0109750
c0105376:	68 b6 96 10 c0       	push   $0xc01096b6
c010537b:	68 cb 00 00 00       	push   $0xcb
c0105380:	68 cb 96 10 c0       	push   $0xc01096cb
...
c01053a0:	68 6c 97 10 c0       	push   $0xc010976c
c01053a5:	68 b6 96 10 c0       	push   $0xc01096b6
c01053aa:	68 cc 00 00 00       	push   $0xcc
c01053af:	68 cb 96 10 c0       	push   $0xc01096cb
...
c01053d1:	68 88 97 10 c0       	push   $0xc0109788
c01053d6:	68 b6 96 10 c0       	push   $0xc01096b6
c01053db:	68 ce 00 00 00       	push   $0xce
c01053e0:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105420:	68 ac 97 10 c0       	push   $0xc01097ac
c0105425:	68 b6 96 10 c0       	push   $0xc01096b6
c010542a:	68 cf 00 00 00       	push   $0xcf
c010542f:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105455:	68 e8 97 10 c0       	push   $0xc01097e8
c010545a:	68 b6 96 10 c0       	push   $0xc01096b6
c010545f:	68 d1 00 00 00       	push   $0xd1
c0105464:	68 cb 96 10 c0       	push   $0xc01096cb
...
c010548a:	68 05 98 10 c0       	push   $0xc0109805
c010548f:	68 b6 96 10 c0       	push   $0xc01096b6
c0105494:	68 d2 00 00 00       	push   $0xd2
c0105499:	68 cb 96 10 c0       	push   $0xc01096cb
...
c01054bf:	68 22 98 10 c0       	push   $0xc0109822
c01054c4:	68 b6 96 10 c0       	push   $0xc01096b6
c01054c9:	68 d3 00 00 00       	push   $0xd3
c01054ce:	68 cb 96 10 c0       	push   $0xc01096cb
...
c010551e:	68 3f 98 10 c0       	push   $0xc010983f
c0105523:	68 b6 96 10 c0       	push   $0xc01096b6
c0105528:	68 d7 00 00 00       	push   $0xd7
c010552d:	68 cb 96 10 c0       	push   $0xc01096cb
...
c010555a:	68 56 98 10 c0       	push   $0xc0109856
c010555f:	68 b6 96 10 c0       	push   $0xc01096b6
c0105564:	68 dc 00 00 00       	push   $0xdc
c0105569:	68 cb 96 10 c0       	push   $0xc01096cb
...
c01055ad:	68 6b 98 10 c0       	push   $0xc010986b
c01055b2:	68 b6 96 10 c0       	push   $0xc01096b6
c01055b7:	68 e1 00 00 00       	push   $0xe1
c01055bc:	68 cb 96 10 c0       	push   $0xc01096cb
...
c01055dc:	68 34 97 10 c0       	push   $0xc0109734
c01055e1:	68 b6 96 10 c0       	push   $0xc01096b6
c01055e6:	68 e3 00 00 00       	push   $0xe3
c01055eb:	68 cb 96 10 c0       	push   $0xc01096cb
...
c010560b:	68 50 97 10 c0       	push   $0xc0109750
c0105610:	68 b6 96 10 c0       	push   $0xc01096b6
c0105615:	68 e4 00 00 00       	push   $0xe4
c010561a:	68 cb 96 10 c0       	push   $0xc01096cb
...
c010563a:	68 6c 97 10 c0       	push   $0xc010976c
c010563f:	68 b6 96 10 c0       	push   $0xc01096b6
c0105644:	68 e5 00 00 00       	push   $0xe5
c0105649:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105664:	68 56 98 10 c0       	push   $0xc0109856
c0105669:	68 b6 96 10 c0       	push   $0xc01096b6
c010566e:	68 e7 00 00 00       	push   $0xe7
c0105673:	68 cb 96 10 c0       	push   $0xc01096cb
...
c01056a7:	68 78 98 10 c0       	push   $0xc0109878
c01056ac:	68 b6 96 10 c0       	push   $0xc01096b6
c01056b1:	68 ea 00 00 00       	push   $0xea
c01056b6:	68 cb 96 10 c0       	push   $0xc01096cb
...
c01056d8:	68 90 98 10 c0       	push   $0xc0109890
c01056dd:	68 b6 96 10 c0       	push   $0xc01096b6
c01056e2:	68 ed 00 00 00       	push   $0xed
c01056e7:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105702:	68 56 98 10 c0       	push   $0xc0109856
c0105707:	68 b6 96 10 c0       	push   $0xc01096b6
c010570c:	68 ee 00 00 00       	push   $0xee
c0105711:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105724:	68 a9 98 10 c0       	push   $0xc01098a9
c0105729:	68 b6 96 10 c0       	push   $0xc01096b6
c010572e:	68 f0 00 00 00       	push   $0xf0
c0105733:	68 cb 96 10 c0       	push   $0xc01096cb
...
c01057de:	68 b6 98 10 c0       	push   $0xc01098b6
c01057e3:	68 b6 96 10 c0       	push   $0xc01096b6
c01057e8:	68 01 01 00 00       	push   $0x101
c01057ed:	68 cb 96 10 c0       	push   $0xc01096cb
...
c010582f:	68 c6 98 10 c0       	push   $0xc01098c6
c0105834:	68 b6 96 10 c0       	push   $0xc01096b6
c0105839:	68 04 01 00 00       	push   $0x104
c010583e:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105863:	68 df 98 10 c0       	push   $0xc01098df
c0105868:	68 b6 96 10 c0       	push   $0xc01096b6
c010586d:	68 09 01 00 00       	push   $0x109
c0105872:	68 cb 96 10 c0       	push   $0xc01096cb
...
c01058a8:	68 ea 98 10 c0       	push   $0xc01098ea
c01058ad:	68 b6 96 10 c0       	push   $0xc01096b6
c01058b2:	68 0a 01 00 00       	push   $0x10a
c01058b7:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105907:	68 3f 98 10 c0       	push   $0xc010983f
c010590c:	68 b6 96 10 c0       	push   $0xc01096b6
c0105911:	68 0e 01 00 00       	push   $0x10e
c0105916:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105931:	68 56 98 10 c0       	push   $0xc0109856
c0105936:	68 b6 96 10 c0       	push   $0xc01096b6
c010593b:	68 0f 01 00 00       	push   $0x10f
c0105940:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105981:	68 fc 98 10 c0       	push   $0xc01098fc
c0105986:	68 b6 96 10 c0       	push   $0xc01096b6
c010598b:	68 15 01 00 00       	push   $0x115
c0105990:	68 cb 96 10 c0       	push   $0xc01096cb
...
c01059d7:	68 14 99 10 c0       	push   $0xc0109914
c01059dc:	68 b6 96 10 c0       	push   $0xc01096b6
c01059e1:	68 16 01 00 00       	push   $0x116
c01059e6:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105a06:	68 40 99 10 c0       	push   $0xc0109940
c0105a0b:	68 b6 96 10 c0       	push   $0xc01096b6
c0105a10:	68 17 01 00 00       	push   $0x117
c0105a15:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105a30:	68 56 98 10 c0       	push   $0xc0109856
c0105a35:	68 b6 96 10 c0       	push   $0xc01096b6
c0105a3a:	68 18 01 00 00       	push   $0x118
c0105a3f:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105a54:	68 5e 99 10 c0       	push   $0xc010995e
c0105a59:	68 b6 96 10 c0       	push   $0xc01096b6
c0105a5e:	68 19 01 00 00       	push   $0x119
c0105a63:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105acd:	68 6c 99 10 c0       	push   $0xc010996c
c0105ad2:	68 b6 96 10 c0       	push   $0xc01096b6
c0105ad7:	68 1e 01 00 00       	push   $0x11e
c0105adc:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105b1d:	68 94 99 10 c0       	push   $0xc0109994
c0105b22:	68 b6 96 10 c0       	push   $0xc01096b6
c0105b27:	68 1f 01 00 00       	push   $0x11f
c0105b2c:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105b51:	68 ba 99 10 c0       	push   $0xc01099ba
c0105b56:	68 b6 96 10 c0       	push   $0xc01096b6
c0105b5b:	68 21 01 00 00       	push   $0x121
c0105b60:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105b95:	68 d8 99 10 c0       	push   $0xc01099d8
c0105b9a:	68 b6 96 10 c0       	push   $0xc01096b6
c0105b9f:	68 23 01 00 00       	push   $0x123
c0105ba4:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105be4:	68 f8 99 10 c0       	push   $0xc01099f8
c0105be9:	68 b6 96 10 c0       	push   $0xc01096b6
c0105bee:	68 28 01 00 00       	push   $0x128
c0105bf3:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105c0e:	68 56 98 10 c0       	push   $0xc0109856
c0105c13:	68 b6 96 10 c0       	push   $0xc01096b6
c0105c18:	68 29 01 00 00       	push   $0x129
c0105c1d:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105c30:	68 a9 98 10 c0       	push   $0xc01098a9
c0105c35:	68 b6 96 10 c0       	push   $0xc01096b6
c0105c3a:	68 2b 01 00 00       	push   $0x12b
c0105c3f:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105cb6:	68 16 9a 10 c0       	push   $0xc0109a16
c0105cbb:	68 b6 96 10 c0       	push   $0xc01096b6
c0105cc0:	68 36 01 00 00       	push   $0x136
c0105cc5:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105cd5:	68 21 9a 10 c0       	push   $0xc0109a21
c0105cda:	68 b6 96 10 c0       	push   $0xc01096b6
c0105cdf:	68 37 01 00 00       	push   $0x137
c0105ce4:	68 cb 96 10 c0       	push   $0xc01096cb
...
c0105d31:	68 5c 9a 10 c0       	push   $0xc0109a5c
c0105d36:	6a 5b                	push   $0x5b
c0105d38:	68 7b 9a 10 c0       	push   $0xc0109a7b
...
c0105d7e:	68 8c 9a 10 c0       	push   $0xc0109a8c
c0105d83:	6a 62                	push   $0x62
c0105d85:	68 7b 9a 10 c0       	push   $0xc0109a7b
...
c0105db1:	68 b0 9a 10 c0       	push   $0xc0109ab0
c0105db6:	6a 67                	push   $0x67
c0105db8:	68 7b 9a 10 c0       	push   $0xc0109a7b
...
c0105deb:	68 d4 9a 10 c0       	push   $0xc0109ad4
c0105df0:	6a 6d                	push   $0x6d
c0105df2:	68 7b 9a 10 c0       	push   $0xc0109a7b
...
c0105fee:	c7 05 f0 30 12 c0 40 	movl   $0xc0109a40,0xc01230f0
c0105ff5:	9a 10 c0 
...
c0106003:	68 00 9b 10 c0       	push   $0xc0109b00
...
c010612c:	68 17 9b 10 c0       	push   $0xc0109b17
...
c01061de:	68 24 9b 10 c0       	push   $0xc0109b24
...
c010630c:	68 b0 9a 10 c0       	push   $0xc0109ab0
c0106311:	68 e9 00 00 00       	push   $0xe9
c0106316:	68 54 9b 10 c0       	push   $0xc0109b54
...
c01064cc:	68 62 9b 10 c0       	push   $0xc0109b62
c01064d1:	68 79 9b 10 c0       	push   $0xc0109b79
c01064d6:	68 07 01 00 00       	push   $0x107
c01064db:	68 54 9b 10 c0       	push   $0xc0109b54
...
c010655c:	68 8e 9b 10 c0       	push   $0xc0109b8e
c0106561:	68 79 9b 10 c0       	push   $0xc0109b79
c0106566:	68 0d 01 00 00       	push   $0x10d
c010656b:	68 54 9b 10 c0       	push   $0xc0109b54
...
c01065bf:	68 9b 9b 10 c0       	push   $0xc0109b9b
c01065c4:	68 19 01 00 00       	push   $0x119
c01065c9:	68 54 9b 10 c0       	push   $0xc0109b54
...
c01065fd:	68 b0 9a 10 c0       	push   $0xc0109ab0
c0106602:	68 23 01 00 00       	push   $0x123
c0106607:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106651:	68 b0 9a 10 c0       	push   $0xc0109ab0
c0106656:	68 39 01 00 00       	push   $0x139
c010665b:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106731:	68 8c 9a 10 c0       	push   $0xc0109a8c
c0106736:	68 7f 01 00 00       	push   $0x17f
c010673b:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106790:	68 8c 9a 10 c0       	push   $0xc0109a8c
c0106795:	68 82 01 00 00       	push   $0x182
c010679a:	68 54 9b 10 c0       	push   $0xc0109b54
...
c010698e:	68 b0 9a 10 c0       	push   $0xc0109ab0
c0106993:	68 e4 01 00 00       	push   $0x1e4
c0106998:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106a47:	68 b4 9b 10 c0       	push   $0xc0109bb4
c0106a4c:	68 79 9b 10 c0       	push   $0xc0109b79
c0106a51:	68 f7 01 00 00       	push   $0x1f7
c0106a56:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106a78:	68 c8 9b 10 c0       	push   $0xc0109bc8
...
c0106a9a:	68 e7 9b 10 c0       	push   $0xc0109be7
c0106a9f:	68 79 9b 10 c0       	push   $0xc0109b79
c0106aa4:	68 08 02 00 00       	push   $0x208
c0106aa9:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106aca:	68 04 9c 10 c0       	push   $0xc0109c04
c0106acf:	68 79 9b 10 c0       	push   $0xc0109b79
c0106ad4:	68 09 02 00 00       	push   $0x209
c0106ad9:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106afc:	68 3c 9c 10 c0       	push   $0xc0109c3c
c0106b01:	68 79 9b 10 c0       	push   $0xc0109b79
c0106b06:	68 0a 02 00 00       	push   $0x20a
c0106b0b:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106b3e:	68 64 9c 10 c0       	push   $0xc0109c64
c0106b43:	68 79 9b 10 c0       	push   $0xc0109b79
c0106b48:	68 0e 02 00 00       	push   $0x20e
c0106b4d:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106b75:	68 90 9c 10 c0       	push   $0xc0109c90
c0106b7a:	68 79 9b 10 c0       	push   $0xc0109b79
c0106b7f:	68 11 02 00 00       	push   $0x211
c0106b84:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106ba4:	68 bd 9c 10 c0       	push   $0xc0109cbd
c0106ba9:	68 79 9b 10 c0       	push   $0xc0109b79
c0106bae:	68 12 02 00 00       	push   $0x212
c0106bb3:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106bd0:	68 d3 9c 10 c0       	push   $0xc0109cd3
c0106bd5:	68 79 9b 10 c0       	push   $0xc0109b79
c0106bda:	68 13 02 00 00       	push   $0x213
c0106bdf:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106c0e:	68 8c 9a 10 c0       	push   $0xc0109a8c
c0106c13:	68 15 02 00 00       	push   $0x215
c0106c18:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106c4d:	68 e8 9c 10 c0       	push   $0xc0109ce8
c0106c52:	68 79 9b 10 c0       	push   $0xc0109b79
c0106c57:	68 16 02 00 00       	push   $0x216
c0106c5c:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106c92:	68 10 9d 10 c0       	push   $0xc0109d10
c0106c97:	68 79 9b 10 c0       	push   $0xc0109b79
c0106c9c:	68 19 02 00 00       	push   $0x219
c0106ca1:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106ccc:	68 48 9d 10 c0       	push   $0xc0109d48
c0106cd1:	68 79 9b 10 c0       	push   $0xc0109b79
c0106cd6:	68 1a 02 00 00       	push   $0x21a
c0106cdb:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106cf1:	68 78 9d 10 c0       	push   $0xc0109d78
c0106cf6:	68 79 9b 10 c0       	push   $0xc0109b79
c0106cfb:	68 1b 02 00 00       	push   $0x21b
c0106d00:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106d16:	68 86 9d 10 c0       	push   $0xc0109d86
c0106d1b:	68 79 9b 10 c0       	push   $0xc0109b79
c0106d20:	68 1c 02 00 00       	push   $0x21c
c0106d25:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106d3d:	68 94 9d 10 c0       	push   $0xc0109d94
c0106d42:	68 79 9b 10 c0       	push   $0xc0109b79
c0106d47:	68 1d 02 00 00       	push   $0x21d
c0106d4c:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106d69:	68 aa 9d 10 c0       	push   $0xc0109daa
c0106d6e:	68 79 9b 10 c0       	push   $0xc0109b79
c0106d73:	68 1e 02 00 00       	push   $0x21e
c0106d78:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106d9e:	68 bc 9d 10 c0       	push   $0xc0109dbc
c0106da3:	68 79 9b 10 c0       	push   $0xc0109b79
c0106da8:	68 20 02 00 00       	push   $0x220
c0106dad:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106dca:	68 e8 9d 10 c0       	push   $0xc0109de8
c0106dcf:	68 79 9b 10 c0       	push   $0xc0109b79
c0106dd4:	68 21 02 00 00       	push   $0x221
c0106dd9:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106df5:	68 fa 9d 10 c0       	push   $0xc0109dfa
c0106dfa:	68 79 9b 10 c0       	push   $0xc0109b79
c0106dff:	68 22 02 00 00       	push   $0x222
c0106e04:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106e2f:	68 48 9d 10 c0       	push   $0xc0109d48
c0106e34:	68 79 9b 10 c0       	push   $0xc0109b79
c0106e39:	68 23 02 00 00       	push   $0x223
c0106e3e:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106e5e:	68 bd 9c 10 c0       	push   $0xc0109cbd
c0106e63:	68 79 9b 10 c0       	push   $0xc0109b79
c0106e68:	68 24 02 00 00       	push   $0x224
c0106e6d:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106e83:	68 0c 9e 10 c0       	push   $0xc0109e0c
c0106e88:	68 79 9b 10 c0       	push   $0xc0109b79
c0106e8d:	68 25 02 00 00       	push   $0x225
c0106e92:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106ec2:	68 d3 9c 10 c0       	push   $0xc0109cd3
c0106ec7:	68 79 9b 10 c0       	push   $0xc0109b79
c0106ecc:	68 28 02 00 00       	push   $0x228
c0106ed1:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106eed:	68 fa 9d 10 c0       	push   $0xc0109dfa
c0106ef2:	68 79 9b 10 c0       	push   $0xc0109b79
c0106ef7:	68 29 02 00 00       	push   $0x229
c0106efc:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106f2e:	68 21 9e 10 c0       	push   $0xc0109e21
c0106f33:	68 79 9b 10 c0       	push   $0xc0109b79
c0106f38:	68 2c 02 00 00       	push   $0x22c
c0106f3d:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106f59:	68 fa 9d 10 c0       	push   $0xc0109dfa
c0106f5e:	68 79 9b 10 c0       	push   $0xc0109b79
c0106f63:	68 2d 02 00 00       	push   $0x22d
c0106f68:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106f96:	68 34 9e 10 c0       	push   $0xc0109e34
c0106f9b:	68 79 9b 10 c0       	push   $0xc0109b79
c0106fa0:	68 2f 02 00 00       	push   $0x22f
c0106fa5:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0106fde:	68 5b 9e 10 c0       	push   $0xc0109e5b
...
c010701c:	68 8c 9a 10 c0       	push   $0xc0109a8c
c0107021:	68 3b 02 00 00       	push   $0x23b
c0107026:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0107057:	68 78 9e 10 c0       	push   $0xc0109e78
c010705c:	68 79 9b 10 c0       	push   $0xc0109b79
c0107061:	68 3b 02 00 00       	push   $0x23b
c0107066:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0107083:	68 b5 9e 10 c0       	push   $0xc0109eb5
c0107088:	68 79 9b 10 c0       	push   $0xc0109b79
c010708d:	68 3c 02 00 00       	push   $0x23c
c0107092:	68 54 9b 10 c0       	push   $0xc0109b54
...
c01070da:	68 b0 9a 10 c0       	push   $0xc0109ab0
c01070df:	68 3f 02 00 00       	push   $0x23f
c01070e4:	68 54 9b 10 c0       	push   $0xc0109b54
...
c01070fa:	68 cc 9e 10 c0       	push   $0xc0109ecc
c01070ff:	68 79 9b 10 c0       	push   $0xc0109b79
c0107104:	68 3f 02 00 00       	push   $0x23f
c0107109:	68 54 9b 10 c0       	push   $0xc0109b54
...
c010711e:	68 00 9f 10 c0       	push   $0xc0109f00
c0107123:	68 79 9b 10 c0       	push   $0xc0109b79
c0107128:	68 41 02 00 00       	push   $0x241
c010712d:	68 54 9b 10 c0       	push   $0xc0109b54
...
c0107163:	68 14 9f 10 c0       	push   $0xc0109f14
c0107168:	68 79 9b 10 c0       	push   $0xc0109b79
c010716d:	68 45 02 00 00       	push   $0x245
c0107172:	68 54 9b 10 c0       	push   $0xc0109b54
...
c010718f:	68 42 9f 10 c0       	push   $0xc0109f42
c0107194:	68 79 9b 10 c0       	push   $0xc0109b79
c0107199:	68 46 02 00 00       	push   $0x246
c010719e:	68 54 9b 10 c0       	push   $0xc0109b54
...
c01071c4:	68 54 9f 10 c0       	push   $0xc0109f54
c01071c9:	68 79 9b 10 c0       	push   $0xc0109b79
c01071ce:	68 47 02 00 00       	push   $0x247
c01071d3:	68 54 9b 10 c0       	push   $0xc0109b54
...
c01071f0:	68 8b 9f 10 c0       	push   $0xc0109f8b
c01071f5:	68 79 9b 10 c0       	push   $0xc0109b79
c01071fa:	68 48 02 00 00       	push   $0x248
c01071ff:	68 54 9b 10 c0       	push   $0xc0109b54
c0107204:	e8 df 91 ff ff       	call   c01003e8 <__panic>

    const char *str = "ucore: Hello world!!";
c0107209:	c7 45 dc 9c 9f 10 c0 	movl   $0xc0109f9c,-0x24(%ebp)
...
c010723c:	68 b4 9f 10 c0       	push   $0xc0109fb4
c0107241:	68 79 9b 10 c0       	push   $0xc0109b79
c0107246:	68 4c 02 00 00       	push   $0x24c
c010724b:	68 54 9b 10 c0       	push   $0xc0109b54
...
c010727f:	68 ec 9f 10 c0       	push   $0xc0109fec
c0107284:	68 79 9b 10 c0       	push   $0xc0109b79
c0107289:	68 4f 02 00 00       	push   $0x24f
c010728e:	68 54 9b 10 c0       	push   $0xc0109b54
...
c01072d7:	68 10 a0 10 c0       	push   $0xc010a010
...
c01073f5:	68 30 a0 10 c0       	push   $0xc010a030
...
c0107450:	68 61 a0 10 c0       	push   $0xc010a061
...
c01074aa:	68 80 a0 10 c0       	push   $0xc010a080
...
c0107527:	68 a4 a0 10 c0       	push   $0xc010a0a4
...
c0107560:	68 d5 a0 10 c0       	push   $0xc010a0d5
c0107565:	68 79 9b 10 c0       	push   $0xc0109b79
c010756a:	68 9b 02 00 00       	push   $0x29b
c010756f:	68 54 9b 10 c0       	push   $0xc0109b54
...
c010759f:	68 ec a0 10 c0       	push   $0xc010a0ec
c01075a4:	68 79 9b 10 c0       	push   $0xc0109b79
c01075a9:	68 9e 02 00 00       	push   $0x29e
c01075ae:	68 54 9b 10 c0       	push   $0xc0109b54
...
c01075e3:	68 d5 a0 10 c0       	push   $0xc010a0d5
c01075e8:	68 79 9b 10 c0       	push   $0xc0109b79
c01075ed:	68 a5 02 00 00       	push   $0x2a5
c01075f2:	68 54 9b 10 c0       	push   $0xc0109b54
c01075f7:	e8 ec 8d ff ff       	call   c01003e8 <__panic>
    assert(ptr != NULL);
c01075fc:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
c0107600:	75 19                	jne    c010761b <kfree+0x4d>
c0107602:	68 f9 a0 10 c0       	push   $0xc010a0f9
c0107607:	68 79 9b 10 c0       	push   $0xc0109b79
c010760c:	68 a6 02 00 00       	push   $0x2a6
c0107611:	68 54 9b 10 c0       	push   $0xc0109b54
...
c01076a6:	68 08 a1 10 c0       	push   $0xc010a108
c01076ab:	6a 62                	push   $0x62
c01076ad:	68 2b a1 10 c0       	push   $0xc010a12b
...
c01076db:	68 39 a1 10 c0       	push   $0xc010a139
c01076e0:	6a 0d                	push   $0xd
c01076e2:	68 53 a1 10 c0       	push   $0xc010a153
...
c0107736:	68 64 a1 10 c0       	push   $0xc010a164
c010773b:	6a 14                	push   $0x14
c010773d:	68 53 a1 10 c0       	push   $0xc010a153
...
c010778f:	68 64 a1 10 c0       	push   $0xc010a164
c0107794:	6a 19                	push   $0x19
c0107796:	68 53 a1 10 c0       	push   $0xc010a153
...
c0107d46:	05 04 a2 10 c0       	add    $0xc010a204,%eax
...
c0107e8b:	8b 04 85 28 a2 10 c0 	mov    -0x3fef5dd8(,%eax,4),%eax
...
c0107f82:	68 1e a2 10 c0       	push   $0xc010a21e
...
c0107fa7:	75 05                	jne    c0107fae <vprintfmt+0x191>
                p = "(null)";
c0107fa9:	be 21 a2 10 c0       	mov    $0xc010a221,%esi
            }
            if (width > 0 && padc != '-') {
