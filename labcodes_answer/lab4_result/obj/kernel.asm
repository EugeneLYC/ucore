...
c010003c:	ba 64 d1 12 c0       	mov    $0xc012d164,%edx
...
c010009f:	e8 be 20 00 00       	call   c0102162 <ide_init>
    swap_init();                // init swap
c01000a4:	e8 1d 5d 00 00       	call   c0105dc6 <swap_init>
...
c0100339:	e8 a1 58 00 00       	call   c0105bdf <kmalloc>
...
c0100393:	e8 47 58 00 00       	call   c0105bdf <kmalloc>
...
c0100442:	e8 b0 57 00 00       	call   c0105bf7 <kfree>
...
c0100453:	e8 9f 57 00 00       	call   c0105bf7 <kfree>
...
c0100db3:	e8 3f 4e 00 00       	call   c0105bf7 <kfree>
...
c010106d:	e8 6d 4b 00 00       	call   c0105bdf <kmalloc>
...
c0101670:	e8 82 45 00 00       	call   c0105bf7 <kfree>
...
c0101cf9:	68 64 d1 12 c0       	push   $0xc012d164
...
c0101d0b:	b8 64 d1 12 c0       	mov    $0xc012d164,%eax
...
c0104554:	e8 0f d2 ff ff       	call   c0101768 <__panic>
    ...
    return &pages[PPN(pa)];
c0104559:	8b 0d 58 d1 12 c0    	mov    0xc012d158,%ecx
...
c010459c:	e8 3e 16 00 00       	call   c0105bdf <kmalloc>
...
c01045e5:	a1 6c af 12 c0       	mov    0xc012af6c,%eax
...
c01045f4:	e8 50 18 00 00       	call   c0105e49 <swap_init_mm>
...
c0104618:	e8 c2 15 00 00       	call   c0105bdf <kmalloc>
...
c01048d9:	e8 19 13 00 00       	call   c0105bf7 <kfree>
...
c01048fe:	e8 f4 12 00 00       	call   c0105bf7 <kfree>
...
c01050ad:	e9 97 00 00 00       	jmp    c0105149 <do_pgfault+0x1fe>
        ...
        if(swap_init_ok) {
c01050b2:	a1 6c af 12 c0       	mov    0xc012af6c,%eax
...
c01050cf:	e8 3b 0f 00 00       	call   c010600f <swap_in>
...
c0105117:	e8 63 0d 00 00       	call   c0105e7f <swap_map_swappable>
...
c0105151:	83 ec 10             	sub    $0x10,%esp
c0105154:	c7 45 fc 5c d0 12 c0 	movl   $0xc012d05c,-0x4(%ebp)
 * list_init - initialize a new entry
 * @elm:        new entry to be initialized
 * */
static inline void
list_init(list_entry_t *elm) {
    elm->prev = elm->next = elm;
c010515b:	8b 45 fc             	mov    -0x4(%ebp),%eax
c010515e:	8b 55 fc             	mov    -0x4(%ebp),%edx
c0105161:	89 50 04             	mov    %edx,0x4(%eax)
c0105164:	8b 45 fc             	mov    -0x4(%ebp),%eax
c0105167:	8b 50 04             	mov    0x4(%eax),%edx
c010516a:	8b 45 fc             	mov    -0x4(%ebp),%eax
c010516d:	89 10                	mov    %edx,(%eax)
     list_init(&pra_list_head);
     mm->sm_priv = &pra_list_head;
c010516f:	8b 45 08             	mov    0x8(%ebp),%eax
c0105172:	c7 40 14 5c d0 12 c0 	movl   $0xc012d05c,0x14(%eax)
     //cprintf(" mm->sm_priv %x in fifo_init_mm\n",mm->sm_priv);
     return 0;
c0105179:	b8 00 00 00 00       	mov    $0x0,%eax
}
c010517e:	c9                   	leave  
c010517f:	c3                   	ret    

c0105180 <_fifo_map_swappable>:
/*
...
c0105183:	83 ec 38             	sub    $0x38,%esp
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
c0105186:	8b 45 08             	mov    0x8(%ebp),%eax
c0105189:	8b 40 14             	mov    0x14(%eax),%eax
c010518c:	89 45 f4             	mov    %eax,-0xc(%ebp)
    list_entry_t *entry=&(page->pra_page_link);
c010518f:	8b 45 10             	mov    0x10(%ebp),%eax
c0105192:	83 c0 18             	add    $0x18,%eax
c0105195:	89 45 f0             	mov    %eax,-0x10(%ebp)
 
    assert(entry != NULL && head != NULL);
c0105198:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
c010519c:	74 06                	je     c01051a4 <_fifo_map_swappable+0x24>
c010519e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
c01051a2:	75 16                	jne    c01051ba <_fifo_map_swappable+0x3a>
c01051a4:	68 5c b8 10 c0       	push   $0xc010b85c
c01051a9:	68 7a b8 10 c0       	push   $0xc010b87a
c01051ae:	6a 32                	push   $0x32
c01051b0:	68 8f b8 10 c0       	push   $0xc010b88f
c01051b5:	e8 ae c5 ff ff       	call   c0101768 <__panic>
c01051ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
c01051bd:	89 45 ec             	mov    %eax,-0x14(%ebp)
c01051c0:	8b 45 f0             	mov    -0x10(%ebp),%eax
c01051c3:	89 45 e8             	mov    %eax,-0x18(%ebp)
c01051c6:	8b 45 ec             	mov    -0x14(%ebp),%eax
c01051c9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
c01051cc:	8b 45 e8             	mov    -0x18(%ebp),%eax
c01051cf:	89 45 e0             	mov    %eax,-0x20(%ebp)
 * Insert the new element @elm *after* the element @listelm which
 * is already in the list.
 * */
static inline void
list_add_after(list_entry_t *listelm, list_entry_t *elm) {
    __list_add(elm, listelm, listelm->next);
c01051d2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c01051d5:	8b 40 04             	mov    0x4(%eax),%eax
c01051d8:	8b 55 e0             	mov    -0x20(%ebp),%edx
c01051db:	89 55 dc             	mov    %edx,-0x24(%ebp)
c01051de:	8b 55 e4             	mov    -0x1c(%ebp),%edx
c01051e1:	89 55 d8             	mov    %edx,-0x28(%ebp)
c01051e4:	89 45 d4             	mov    %eax,-0x2c(%ebp)
 * This is only for internal list manipulation where we know
 * the prev/next entries already!
 * */
static inline void
__list_add(list_entry_t *elm, list_entry_t *prev, list_entry_t *next) {
    prev->next = next->prev = elm;
c01051e7:	8b 45 d4             	mov    -0x2c(%ebp),%eax
c01051ea:	8b 55 dc             	mov    -0x24(%ebp),%edx
c01051ed:	89 10                	mov    %edx,(%eax)
c01051ef:	8b 45 d4             	mov    -0x2c(%ebp),%eax
c01051f2:	8b 10                	mov    (%eax),%edx
c01051f4:	8b 45 d8             	mov    -0x28(%ebp),%eax
c01051f7:	89 50 04             	mov    %edx,0x4(%eax)
    elm->next = next;
c01051fa:	8b 45 dc             	mov    -0x24(%ebp),%eax
c01051fd:	8b 55 d4             	mov    -0x2c(%ebp),%edx
c0105200:	89 50 04             	mov    %edx,0x4(%eax)
    elm->prev = prev;
c0105203:	8b 45 dc             	mov    -0x24(%ebp),%eax
c0105206:	8b 55 d8             	mov    -0x28(%ebp),%edx
c0105209:	89 10                	mov    %edx,(%eax)
    //record the page access situlation
    /*LAB3 EXERCISE 2: YOUR CODE*/ 
    //(1)link the most recent arrival page at the back of the pra_list_head qeueue.
    list_add(head, entry);
    return 0;
c010520b:	b8 00 00 00 00       	mov    $0x0,%eax
}
c0105210:	c9                   	leave  
c0105211:	c3                   	ret    

c0105212 <_fifo_swap_out_victim>:
...
c0105215:	83 ec 28             	sub    $0x28,%esp
     list_entry_t *head=(list_entry_t*) mm->sm_priv;
c0105218:	8b 45 08             	mov    0x8(%ebp),%eax
c010521b:	8b 40 14             	mov    0x14(%eax),%eax
c010521e:	89 45 f4             	mov    %eax,-0xc(%ebp)
         assert(head != NULL);
c0105221:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
c0105225:	75 16                	jne    c010523d <_fifo_swap_out_victim+0x2b>
c0105227:	68 a3 b8 10 c0       	push   $0xc010b8a3
c010522c:	68 7a b8 10 c0       	push   $0xc010b87a
c0105231:	6a 41                	push   $0x41
c0105233:	68 8f b8 10 c0       	push   $0xc010b88f
c0105238:	e8 2b c5 ff ff       	call   c0101768 <__panic>
     assert(in_tick==0);
c010523d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
c0105241:	74 16                	je     c0105259 <_fifo_swap_out_victim+0x47>
c0105243:	68 b0 b8 10 c0       	push   $0xc010b8b0
c0105248:	68 7a b8 10 c0       	push   $0xc010b87a
c010524d:	6a 42                	push   $0x42
c010524f:	68 8f b8 10 c0       	push   $0xc010b88f
c0105254:	e8 0f c5 ff ff       	call   c0101768 <__panic>
     /* Select the victim */
     /*LAB3 EXERCISE 2: YOUR CODE*/ 
...
c0105264:	3b 45 f0             	cmp    -0x10(%ebp),%eax
c0105267:	75 16                	jne    c010527f <_fifo_swap_out_victim+0x6d>
c0105269:	68 bb b8 10 c0       	push   $0xc010b8bb
c010526e:	68 7a b8 10 c0       	push   $0xc010b87a
c0105273:	6a 49                	push   $0x49
c0105275:	68 8f b8 10 c0       	push   $0xc010b88f
c010527a:	e8 e9 c4 ff ff       	call   c0101768 <__panic>
     struct Page *p = le2page(le, pra_page_link);
c010527f:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105282:	83 e8 18             	sub    $0x18,%eax
c0105285:	89 45 ec             	mov    %eax,-0x14(%ebp)
c0105288:	8b 45 f0             	mov    -0x10(%ebp),%eax
...
list_del(list_entry_t *listelm) {
    __list_del(listelm->prev, listelm->next);
c010528e:	8b 45 e8             	mov    -0x18(%ebp),%eax
c0105291:	8b 40 04             	mov    0x4(%eax),%eax
c0105294:	8b 55 e8             	mov    -0x18(%ebp),%edx
c0105297:	8b 12                	mov    (%edx),%edx
c0105299:	89 55 e4             	mov    %edx,-0x1c(%ebp)
...
__list_del(list_entry_t *prev, list_entry_t *next) {
    prev->next = next;
c010529f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c01052a2:	8b 55 e0             	mov    -0x20(%ebp),%edx
c01052a5:	89 50 04             	mov    %edx,0x4(%eax)
    next->prev = prev;
c01052a8:	8b 45 e0             	mov    -0x20(%ebp),%eax
c01052ab:	8b 55 e4             	mov    -0x1c(%ebp),%edx
c01052ae:	89 10                	mov    %edx,(%eax)
     list_del(le);
     assert(p !=NULL);
c01052b0:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
c01052b4:	75 16                	jne    c01052cc <_fifo_swap_out_victim+0xba>
c01052b6:	68 c4 b8 10 c0       	push   $0xc010b8c4
c01052bb:	68 7a b8 10 c0       	push   $0xc010b87a
c01052c0:	6a 4c                	push   $0x4c
c01052c2:	68 8f b8 10 c0       	push   $0xc010b88f
c01052c7:	e8 9c c4 ff ff       	call   c0101768 <__panic>
     *ptr_page = p;
c01052cc:	8b 45 0c             	mov    0xc(%ebp),%eax
c01052cf:	8b 55 ec             	mov    -0x14(%ebp),%edx
...
c01052e1:	83 ec 0c             	sub    $0xc,%esp
c01052e4:	68 d0 b8 10 c0       	push   $0xc010b8d0
c01052e9:	e8 9c af ff ff       	call   c010028a <cprintf>
c01052ee:	83 c4 10             	add    $0x10,%esp
    *(unsigned char *)0x3000 = 0x0c;
c01052f1:	b8 00 30 00 00       	mov    $0x3000,%eax
c01052f6:	c6 00 0c             	movb   $0xc,(%eax)
    assert(pgfault_num==4);
c01052f9:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c01052fe:	83 f8 04             	cmp    $0x4,%eax
c0105301:	74 16                	je     c0105319 <_fifo_check_swap+0x3e>
c0105303:	68 f6 b8 10 c0       	push   $0xc010b8f6
c0105308:	68 7a b8 10 c0       	push   $0xc010b87a
c010530d:	6a 55                	push   $0x55
c010530f:	68 8f b8 10 c0       	push   $0xc010b88f
c0105314:	e8 4f c4 ff ff       	call   c0101768 <__panic>
    cprintf("write Virt Page a in fifo_check_swap\n");
c0105319:	83 ec 0c             	sub    $0xc,%esp
c010531c:	68 08 b9 10 c0       	push   $0xc010b908
c0105321:	e8 64 af ff ff       	call   c010028a <cprintf>
c0105326:	83 c4 10             	add    $0x10,%esp
    *(unsigned char *)0x1000 = 0x0a;
c0105329:	b8 00 10 00 00       	mov    $0x1000,%eax
c010532e:	c6 00 0a             	movb   $0xa,(%eax)
    assert(pgfault_num==4);
c0105331:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c0105336:	83 f8 04             	cmp    $0x4,%eax
c0105339:	74 16                	je     c0105351 <_fifo_check_swap+0x76>
c010533b:	68 f6 b8 10 c0       	push   $0xc010b8f6
c0105340:	68 7a b8 10 c0       	push   $0xc010b87a
c0105345:	6a 58                	push   $0x58
c0105347:	68 8f b8 10 c0       	push   $0xc010b88f
c010534c:	e8 17 c4 ff ff       	call   c0101768 <__panic>
    cprintf("write Virt Page d in fifo_check_swap\n");
c0105351:	83 ec 0c             	sub    $0xc,%esp
c0105354:	68 30 b9 10 c0       	push   $0xc010b930
c0105359:	e8 2c af ff ff       	call   c010028a <cprintf>
c010535e:	83 c4 10             	add    $0x10,%esp
    *(unsigned char *)0x4000 = 0x0d;
c0105361:	b8 00 40 00 00       	mov    $0x4000,%eax
c0105366:	c6 00 0d             	movb   $0xd,(%eax)
    assert(pgfault_num==4);
c0105369:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c010536e:	83 f8 04             	cmp    $0x4,%eax
c0105371:	74 16                	je     c0105389 <_fifo_check_swap+0xae>
c0105373:	68 f6 b8 10 c0       	push   $0xc010b8f6
c0105378:	68 7a b8 10 c0       	push   $0xc010b87a
c010537d:	6a 5b                	push   $0x5b
c010537f:	68 8f b8 10 c0       	push   $0xc010b88f
c0105384:	e8 df c3 ff ff       	call   c0101768 <__panic>
    cprintf("write Virt Page b in fifo_check_swap\n");
c0105389:	83 ec 0c             	sub    $0xc,%esp
c010538c:	68 58 b9 10 c0       	push   $0xc010b958
c0105391:	e8 f4 ae ff ff       	call   c010028a <cprintf>
c0105396:	83 c4 10             	add    $0x10,%esp
    *(unsigned char *)0x2000 = 0x0b;
c0105399:	b8 00 20 00 00       	mov    $0x2000,%eax
c010539e:	c6 00 0b             	movb   $0xb,(%eax)
    assert(pgfault_num==4);
c01053a1:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c01053a6:	83 f8 04             	cmp    $0x4,%eax
c01053a9:	74 16                	je     c01053c1 <_fifo_check_swap+0xe6>
c01053ab:	68 f6 b8 10 c0       	push   $0xc010b8f6
c01053b0:	68 7a b8 10 c0       	push   $0xc010b87a
c01053b5:	6a 5e                	push   $0x5e
c01053b7:	68 8f b8 10 c0       	push   $0xc010b88f
c01053bc:	e8 a7 c3 ff ff       	call   c0101768 <__panic>
    cprintf("write Virt Page e in fifo_check_swap\n");
c01053c1:	83 ec 0c             	sub    $0xc,%esp
c01053c4:	68 80 b9 10 c0       	push   $0xc010b980
c01053c9:	e8 bc ae ff ff       	call   c010028a <cprintf>
c01053ce:	83 c4 10             	add    $0x10,%esp
    *(unsigned char *)0x5000 = 0x0e;
c01053d1:	b8 00 50 00 00       	mov    $0x5000,%eax
c01053d6:	c6 00 0e             	movb   $0xe,(%eax)
    assert(pgfault_num==5);
c01053d9:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c01053de:	83 f8 05             	cmp    $0x5,%eax
c01053e1:	74 16                	je     c01053f9 <_fifo_check_swap+0x11e>
c01053e3:	68 a6 b9 10 c0       	push   $0xc010b9a6
c01053e8:	68 7a b8 10 c0       	push   $0xc010b87a
c01053ed:	6a 61                	push   $0x61
c01053ef:	68 8f b8 10 c0       	push   $0xc010b88f
c01053f4:	e8 6f c3 ff ff       	call   c0101768 <__panic>
    cprintf("write Virt Page b in fifo_check_swap\n");
c01053f9:	83 ec 0c             	sub    $0xc,%esp
c01053fc:	68 58 b9 10 c0       	push   $0xc010b958
c0105401:	e8 84 ae ff ff       	call   c010028a <cprintf>
c0105406:	83 c4 10             	add    $0x10,%esp
    *(unsigned char *)0x2000 = 0x0b;
c0105409:	b8 00 20 00 00       	mov    $0x2000,%eax
c010540e:	c6 00 0b             	movb   $0xb,(%eax)
    assert(pgfault_num==5);
c0105411:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c0105416:	83 f8 05             	cmp    $0x5,%eax
c0105419:	74 16                	je     c0105431 <_fifo_check_swap+0x156>
c010541b:	68 a6 b9 10 c0       	push   $0xc010b9a6
c0105420:	68 7a b8 10 c0       	push   $0xc010b87a
c0105425:	6a 64                	push   $0x64
c0105427:	68 8f b8 10 c0       	push   $0xc010b88f
c010542c:	e8 37 c3 ff ff       	call   c0101768 <__panic>
    cprintf("write Virt Page a in fifo_check_swap\n");
c0105431:	83 ec 0c             	sub    $0xc,%esp
c0105434:	68 08 b9 10 c0       	push   $0xc010b908
c0105439:	e8 4c ae ff ff       	call   c010028a <cprintf>
c010543e:	83 c4 10             	add    $0x10,%esp
    *(unsigned char *)0x1000 = 0x0a;
c0105441:	b8 00 10 00 00       	mov    $0x1000,%eax
c0105446:	c6 00 0a             	movb   $0xa,(%eax)
    assert(pgfault_num==6);
c0105449:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c010544e:	83 f8 06             	cmp    $0x6,%eax
c0105451:	74 16                	je     c0105469 <_fifo_check_swap+0x18e>
c0105453:	68 b5 b9 10 c0       	push   $0xc010b9b5
c0105458:	68 7a b8 10 c0       	push   $0xc010b87a
c010545d:	6a 67                	push   $0x67
c010545f:	68 8f b8 10 c0       	push   $0xc010b88f
c0105464:	e8 ff c2 ff ff       	call   c0101768 <__panic>
    cprintf("write Virt Page b in fifo_check_swap\n");
c0105469:	83 ec 0c             	sub    $0xc,%esp
c010546c:	68 58 b9 10 c0       	push   $0xc010b958
c0105471:	e8 14 ae ff ff       	call   c010028a <cprintf>
c0105476:	83 c4 10             	add    $0x10,%esp
    *(unsigned char *)0x2000 = 0x0b;
c0105479:	b8 00 20 00 00       	mov    $0x2000,%eax
c010547e:	c6 00 0b             	movb   $0xb,(%eax)
    assert(pgfault_num==7);
c0105481:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c0105486:	83 f8 07             	cmp    $0x7,%eax
c0105489:	74 16                	je     c01054a1 <_fifo_check_swap+0x1c6>
c010548b:	68 c4 b9 10 c0       	push   $0xc010b9c4
c0105490:	68 7a b8 10 c0       	push   $0xc010b87a
c0105495:	6a 6a                	push   $0x6a
c0105497:	68 8f b8 10 c0       	push   $0xc010b88f
c010549c:	e8 c7 c2 ff ff       	call   c0101768 <__panic>
    cprintf("write Virt Page c in fifo_check_swap\n");
c01054a1:	83 ec 0c             	sub    $0xc,%esp
c01054a4:	68 d0 b8 10 c0       	push   $0xc010b8d0
c01054a9:	e8 dc ad ff ff       	call   c010028a <cprintf>
c01054ae:	83 c4 10             	add    $0x10,%esp
    *(unsigned char *)0x3000 = 0x0c;
c01054b1:	b8 00 30 00 00       	mov    $0x3000,%eax
c01054b6:	c6 00 0c             	movb   $0xc,(%eax)
    assert(pgfault_num==8);
c01054b9:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c01054be:	83 f8 08             	cmp    $0x8,%eax
c01054c1:	74 16                	je     c01054d9 <_fifo_check_swap+0x1fe>
c01054c3:	68 d3 b9 10 c0       	push   $0xc010b9d3
c01054c8:	68 7a b8 10 c0       	push   $0xc010b87a
c01054cd:	6a 6d                	push   $0x6d
c01054cf:	68 8f b8 10 c0       	push   $0xc010b88f
c01054d4:	e8 8f c2 ff ff       	call   c0101768 <__panic>
    cprintf("write Virt Page d in fifo_check_swap\n");
c01054d9:	83 ec 0c             	sub    $0xc,%esp
c01054dc:	68 30 b9 10 c0       	push   $0xc010b930
c01054e1:	e8 a4 ad ff ff       	call   c010028a <cprintf>
c01054e6:	83 c4 10             	add    $0x10,%esp
    *(unsigned char *)0x4000 = 0x0d;
c01054e9:	b8 00 40 00 00       	mov    $0x4000,%eax
c01054ee:	c6 00 0d             	movb   $0xd,(%eax)
    assert(pgfault_num==9);
c01054f1:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c01054f6:	83 f8 09             	cmp    $0x9,%eax
c01054f9:	74 16                	je     c0105511 <_fifo_check_swap+0x236>
c01054fb:	68 e2 b9 10 c0       	push   $0xc010b9e2
c0105500:	68 7a b8 10 c0       	push   $0xc010b87a
c0105505:	6a 70                	push   $0x70
c0105507:	68 8f b8 10 c0       	push   $0xc010b88f
c010550c:	e8 57 c2 ff ff       	call   c0101768 <__panic>
    cprintf("write Virt Page e in fifo_check_swap\n");
c0105511:	83 ec 0c             	sub    $0xc,%esp
c0105514:	68 80 b9 10 c0       	push   $0xc010b980
c0105519:	e8 6c ad ff ff       	call   c010028a <cprintf>
c010551e:	83 c4 10             	add    $0x10,%esp
    *(unsigned char *)0x5000 = 0x0e;
c0105521:	b8 00 50 00 00       	mov    $0x5000,%eax
c0105526:	c6 00 0e             	movb   $0xe,(%eax)
    assert(pgfault_num==10);
c0105529:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c010552e:	83 f8 0a             	cmp    $0xa,%eax
c0105531:	74 16                	je     c0105549 <_fifo_check_swap+0x26e>
c0105533:	68 f1 b9 10 c0       	push   $0xc010b9f1
c0105538:	68 7a b8 10 c0       	push   $0xc010b87a
c010553d:	6a 73                	push   $0x73
c010553f:	68 8f b8 10 c0       	push   $0xc010b88f
c0105544:	e8 1f c2 ff ff       	call   c0101768 <__panic>
    cprintf("write Virt Page a in fifo_check_swap\n");
c0105549:	83 ec 0c             	sub    $0xc,%esp
c010554c:	68 08 b9 10 c0       	push   $0xc010b908
c0105551:	e8 34 ad ff ff       	call   c010028a <cprintf>
c0105556:	83 c4 10             	add    $0x10,%esp
    assert(*(unsigned char *)0x1000 == 0x0a);
c0105559:	b8 00 10 00 00       	mov    $0x1000,%eax
c010555e:	0f b6 00             	movzbl (%eax),%eax
c0105561:	3c 0a                	cmp    $0xa,%al
c0105563:	74 16                	je     c010557b <_fifo_check_swap+0x2a0>
c0105565:	68 04 ba 10 c0       	push   $0xc010ba04
c010556a:	68 7a b8 10 c0       	push   $0xc010b87a
c010556f:	6a 75                	push   $0x75
c0105571:	68 8f b8 10 c0       	push   $0xc010b88f
c0105576:	e8 ed c1 ff ff       	call   c0101768 <__panic>
    *(unsigned char *)0x1000 = 0x0a;
c010557b:	b8 00 10 00 00       	mov    $0x1000,%eax
c0105580:	c6 00 0a             	movb   $0xa,(%eax)
    assert(pgfault_num==11);
c0105583:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c0105588:	83 f8 0b             	cmp    $0xb,%eax
c010558b:	74 16                	je     c01055a3 <_fifo_check_swap+0x2c8>
c010558d:	68 25 ba 10 c0       	push   $0xc010ba25
c0105592:	68 7a b8 10 c0       	push   $0xc010b87a
c0105597:	6a 77                	push   $0x77
c0105599:	68 8f b8 10 c0       	push   $0xc010b88f
c010559e:	e8 c5 c1 ff ff       	call   c0101768 <__panic>
    return 0;
...
c01055ab:	89 e5                	mov    %esp,%ebp
    return 0;
c01055ad:	b8 00 00 00 00       	mov    $0x0,%eax
}
c01055b2:	5d                   	pop    %ebp
c01055b3:	c3                   	ret    

c01055b4 <_fifo_set_unswappable>:
...
c01055b5:	89 e5                	mov    %esp,%ebp
    return 0;
c01055b7:	b8 00 00 00 00       	mov    $0x0,%eax
}
c01055bc:	5d                   	pop    %ebp
c01055bd:	c3                   	ret    

c01055be <_fifo_tick_event>:
...
c01055c1:	b8 00 00 00 00       	mov    $0x0,%eax
c01055c6:	5d                   	pop    %ebp
c01055c7:	c3                   	ret    

c01055c8 <__intr_save>:
#include <x86.h>
#include <intr.h>
#include <mmu.h>
...
c01055cb:	83 ec 18             	sub    $0x18,%esp
}
...
c01055ce:	9c                   	pushf  
c01055cf:	58                   	pop    %eax
c01055d0:	89 45 f4             	mov    %eax,-0xc(%ebp)
    return eflags;
c01055d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
    if (read_eflags() & FL_IF) {
c01055d6:	25 00 02 00 00       	and    $0x200,%eax
c01055db:	85 c0                	test   %eax,%eax
c01055dd:	74 0c                	je     c01055eb <__intr_save+0x23>
        intr_disable();
c01055df:	e8 65 de ff ff       	call   c0103449 <intr_disable>
        return 1;
c01055e4:	b8 01 00 00 00       	mov    $0x1,%eax
c01055e9:	eb 05                	jmp    c01055f0 <__intr_save+0x28>
    }
    return 0;
c01055eb:	b8 00 00 00 00       	mov    $0x0,%eax
}
c01055f0:	c9                   	leave  
c01055f1:	c3                   	ret    

c01055f2 <__intr_restore>:
...
c01055f5:	83 ec 08             	sub    $0x8,%esp
    if (flag) {
c01055f8:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
c01055fc:	74 05                	je     c0105603 <__intr_restore+0x11>
        intr_enable();
c01055fe:	e8 3f de ff ff       	call   c0103442 <intr_enable>
    }
}
c0105603:	90                   	nop
c0105604:	c9                   	leave  
...
c0105606:	55                   	push   %ebp
c0105607:	89 e5                	mov    %esp,%ebp
    return page - pages;
c0105609:	8b 45 08             	mov    0x8(%ebp),%eax
c010560c:	8b 15 58 d1 12 c0    	mov    0xc012d158,%edx
c0105612:	29 d0                	sub    %edx,%eax
c0105614:	c1 f8 02             	sar    $0x2,%eax
c0105617:	69 c0 39 8e e3 38    	imul   $0x38e38e39,%eax,%eax
}
c010561d:	5d                   	pop    %ebp
c010561e:	c3                   	ret    
...
static inline uintptr_t
page2pa(struct Page *page) {
c010561f:	55                   	push   %ebp
c0105620:	89 e5                	mov    %esp,%ebp
    return page2ppn(page) << PGSHIFT;
c0105622:	ff 75 08             	pushl  0x8(%ebp)
c0105625:	e8 dc ff ff ff       	call   c0105606 <page2ppn>
c010562a:	83 c4 04             	add    $0x4,%esp
c010562d:	c1 e0 0c             	shl    $0xc,%eax
}
c0105630:	c9                   	leave  
c0105631:	c3                   	ret    
...
c0105635:	83 ec 08             	sub    $0x8,%esp
    if (PPN(pa) >= npage) {
c0105638:	8b 45 08             	mov    0x8(%ebp),%eax
c010563b:	c1 e8 0c             	shr    $0xc,%eax
c010563e:	89 c2                	mov    %eax,%edx
c0105640:	a1 80 af 12 c0       	mov    0xc012af80,%eax
c0105645:	39 c2                	cmp    %eax,%edx
c0105647:	72 14                	jb     c010565d <pa2page+0x2b>
        panic("pa2page called with invalid pa");
c0105649:	83 ec 04             	sub    $0x4,%esp
c010564c:	68 48 ba 10 c0       	push   $0xc010ba48
c0105651:	6a 5f                	push   $0x5f
c0105653:	68 67 ba 10 c0       	push   $0xc010ba67
c0105658:	e8 0b c1 ff ff       	call   c0101768 <__panic>
    }
    return &pages[PPN(pa)];
c010565d:	8b 0d 58 d1 12 c0    	mov    0xc012d158,%ecx
c0105663:	8b 45 08             	mov    0x8(%ebp),%eax
c0105666:	c1 e8 0c             	shr    $0xc,%eax
c0105669:	89 c2                	mov    %eax,%edx
c010566b:	89 d0                	mov    %edx,%eax
c010566d:	c1 e0 03             	shl    $0x3,%eax
c0105670:	01 d0                	add    %edx,%eax
c0105672:	c1 e0 02             	shl    $0x2,%eax
c0105675:	01 c8                	add    %ecx,%eax
}
c0105677:	c9                   	leave  
c0105678:	c3                   	ret    
...
c010567c:	83 ec 18             	sub    $0x18,%esp
    return KADDR(page2pa(page));
c010567f:	ff 75 08             	pushl  0x8(%ebp)
c0105682:	e8 98 ff ff ff       	call   c010561f <page2pa>
c0105687:	83 c4 04             	add    $0x4,%esp
c010568a:	89 45 f4             	mov    %eax,-0xc(%ebp)
c010568d:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105690:	c1 e8 0c             	shr    $0xc,%eax
c0105693:	89 45 f0             	mov    %eax,-0x10(%ebp)
c0105696:	a1 80 af 12 c0       	mov    0xc012af80,%eax
c010569b:	39 45 f0             	cmp    %eax,-0x10(%ebp)
c010569e:	72 14                	jb     c01056b4 <page2kva+0x3b>
c01056a0:	ff 75 f4             	pushl  -0xc(%ebp)
c01056a3:	68 78 ba 10 c0       	push   $0xc010ba78
c01056a8:	6a 66                	push   $0x66
c01056aa:	68 67 ba 10 c0       	push   $0xc010ba67
c01056af:	e8 b4 c0 ff ff       	call   c0101768 <__panic>
c01056b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
c01056b7:	2d 00 00 00 40       	sub    $0x40000000,%eax
}
c01056bc:	c9                   	leave  
c01056bd:	c3                   	ret    
...
c01056c1:	83 ec 18             	sub    $0x18,%esp
    return pa2page(PADDR(kva));
c01056c4:	8b 45 08             	mov    0x8(%ebp),%eax
c01056c7:	89 45 f4             	mov    %eax,-0xc(%ebp)
c01056ca:	81 7d f4 ff ff ff bf 	cmpl   $0xbfffffff,-0xc(%ebp)
c01056d1:	77 14                	ja     c01056e7 <kva2page+0x29>
c01056d3:	ff 75 f4             	pushl  -0xc(%ebp)
c01056d6:	68 9c ba 10 c0       	push   $0xc010ba9c
c01056db:	6a 6b                	push   $0x6b
c01056dd:	68 67 ba 10 c0       	push   $0xc010ba67
c01056e2:	e8 81 c0 ff ff       	call   c0101768 <__panic>
c01056e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
c01056ea:	05 00 00 00 40       	add    $0x40000000,%eax
c01056ef:	83 ec 0c             	sub    $0xc,%esp
c01056f2:	50                   	push   %eax
c01056f3:	e8 3a ff ff ff       	call   c0105632 <pa2page>
c01056f8:	83 c4 10             	add    $0x10,%esp
}
c01056fb:	c9                   	leave  
c01056fc:	c3                   	ret    

c01056fd <__slob_get_free_pages>:
...
c0105700:	83 ec 18             	sub    $0x18,%esp
  struct Page * page = alloc_pages(1 << order);
c0105703:	8b 45 0c             	mov    0xc(%ebp),%eax
c0105706:	ba 01 00 00 00       	mov    $0x1,%edx
c010570b:	89 c1                	mov    %eax,%ecx
c010570d:	d3 e2                	shl    %cl,%edx
c010570f:	89 d0                	mov    %edx,%eax
c0105711:	83 ec 0c             	sub    $0xc,%esp
c0105714:	50                   	push   %eax
c0105715:	e8 fb 23 00 00       	call   c0107b15 <alloc_pages>
c010571a:	83 c4 10             	add    $0x10,%esp
c010571d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(!page)
c0105720:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
c0105724:	75 07                	jne    c010572d <__slob_get_free_pages+0x30>
    return NULL;
c0105726:	b8 00 00 00 00       	mov    $0x0,%eax
c010572b:	eb 0e                	jmp    c010573b <__slob_get_free_pages+0x3e>
  return page2kva(page);
c010572d:	83 ec 0c             	sub    $0xc,%esp
c0105730:	ff 75 f4             	pushl  -0xc(%ebp)
c0105733:	e8 41 ff ff ff       	call   c0105679 <page2kva>
c0105738:	83 c4 10             	add    $0x10,%esp
}
c010573b:	c9                   	leave  
c010573c:	c3                   	ret    

c010573d <__slob_free_pages>:
...
c0105740:	53                   	push   %ebx
c0105741:	83 ec 04             	sub    $0x4,%esp
  free_pages(kva2page(kva), 1 << order);
c0105744:	8b 45 0c             	mov    0xc(%ebp),%eax
c0105747:	ba 01 00 00 00       	mov    $0x1,%edx
c010574c:	89 c1                	mov    %eax,%ecx
c010574e:	d3 e2                	shl    %cl,%edx
c0105750:	89 d0                	mov    %edx,%eax
c0105752:	89 c3                	mov    %eax,%ebx
c0105754:	8b 45 08             	mov    0x8(%ebp),%eax
c0105757:	83 ec 0c             	sub    $0xc,%esp
c010575a:	50                   	push   %eax
c010575b:	e8 5e ff ff ff       	call   c01056be <kva2page>
c0105760:	83 c4 10             	add    $0x10,%esp
c0105763:	83 ec 08             	sub    $0x8,%esp
c0105766:	53                   	push   %ebx
c0105767:	50                   	push   %eax
c0105768:	e8 14 24 00 00       	call   c0107b81 <free_pages>
c010576d:	83 c4 10             	add    $0x10,%esp
}
c0105770:	90                   	nop
c0105771:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c0105774:	c9                   	leave  
c0105775:	c3                   	ret    
...
c010577f:	83 c0 08             	add    $0x8,%eax
c0105782:	3d ff 0f 00 00       	cmp    $0xfff,%eax
c0105787:	76 16                	jbe    c010579f <slob_alloc+0x29>
c0105789:	68 c0 ba 10 c0       	push   $0xc010bac0
c010578e:	68 df ba 10 c0       	push   $0xc010badf
c0105793:	6a 64                	push   $0x64
c0105795:	68 f4 ba 10 c0       	push   $0xc010baf4
c010579a:	e8 c9 bf ff ff       	call   c0101768 <__panic>

	slob_t *prev, *cur, *aligned = 0;
c010579f:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
	int delta = 0, units = SLOB_UNITS(size);
c01057a6:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
c01057ad:	8b 45 08             	mov    0x8(%ebp),%eax
c01057b0:	83 c0 07             	add    $0x7,%eax
c01057b3:	c1 e8 03             	shr    $0x3,%eax
c01057b6:	89 45 e0             	mov    %eax,-0x20(%ebp)
	unsigned long flags;

	spin_lock_irqsave(&slob_lock, flags);
c01057b9:	e8 0a fe ff ff       	call   c01055c8 <__intr_save>
c01057be:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	prev = slobfree;
c01057c1:	a1 08 7a 12 c0       	mov    0xc0127a08,%eax
c01057c6:	89 45 f4             	mov    %eax,-0xc(%ebp)
	for (cur = prev->next; ; prev = cur, cur = cur->next) {
c01057c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
c01057cc:	8b 40 04             	mov    0x4(%eax),%eax
c01057cf:	89 45 f0             	mov    %eax,-0x10(%ebp)
		if (align) {
c01057d2:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
c01057d6:	74 25                	je     c01057fd <slob_alloc+0x87>
			aligned = (slob_t *)ALIGN((unsigned long)cur, align);
c01057d8:	8b 55 f0             	mov    -0x10(%ebp),%edx
c01057db:	8b 45 10             	mov    0x10(%ebp),%eax
c01057de:	01 d0                	add    %edx,%eax
c01057e0:	8d 50 ff             	lea    -0x1(%eax),%edx
c01057e3:	8b 45 10             	mov    0x10(%ebp),%eax
c01057e6:	f7 d8                	neg    %eax
c01057e8:	21 d0                	and    %edx,%eax
c01057ea:	89 45 ec             	mov    %eax,-0x14(%ebp)
			delta = aligned - cur;
c01057ed:	8b 55 ec             	mov    -0x14(%ebp),%edx
c01057f0:	8b 45 f0             	mov    -0x10(%ebp),%eax
c01057f3:	29 c2                	sub    %eax,%edx
c01057f5:	89 d0                	mov    %edx,%eax
c01057f7:	c1 f8 03             	sar    $0x3,%eax
c01057fa:	89 45 e8             	mov    %eax,-0x18(%ebp)
		}
		if (cur->units >= units + delta) { /* room enough? */
c01057fd:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105800:	8b 00                	mov    (%eax),%eax
c0105802:	8b 4d e0             	mov    -0x20(%ebp),%ecx
c0105805:	8b 55 e8             	mov    -0x18(%ebp),%edx
c0105808:	01 ca                	add    %ecx,%edx
c010580a:	39 d0                	cmp    %edx,%eax
c010580c:	0f 8c b1 00 00 00    	jl     c01058c3 <slob_alloc+0x14d>
			if (delta) { /* need to fragment head to align? */
c0105812:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
c0105816:	74 38                	je     c0105850 <slob_alloc+0xda>
				aligned->units = cur->units - delta;
c0105818:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010581b:	8b 00                	mov    (%eax),%eax
c010581d:	2b 45 e8             	sub    -0x18(%ebp),%eax
c0105820:	89 c2                	mov    %eax,%edx
c0105822:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0105825:	89 10                	mov    %edx,(%eax)
				aligned->next = cur->next;
c0105827:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010582a:	8b 50 04             	mov    0x4(%eax),%edx
c010582d:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0105830:	89 50 04             	mov    %edx,0x4(%eax)
				cur->next = aligned;
c0105833:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105836:	8b 55 ec             	mov    -0x14(%ebp),%edx
c0105839:	89 50 04             	mov    %edx,0x4(%eax)
				cur->units = delta;
c010583c:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010583f:	8b 55 e8             	mov    -0x18(%ebp),%edx
c0105842:	89 10                	mov    %edx,(%eax)
				prev = cur;
c0105844:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105847:	89 45 f4             	mov    %eax,-0xc(%ebp)
				cur = aligned;
...
c0105850:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105853:	8b 00                	mov    (%eax),%eax
c0105855:	3b 45 e0             	cmp    -0x20(%ebp),%eax
c0105858:	75 0e                	jne    c0105868 <slob_alloc+0xf2>
				prev->next = cur->next; /* unlink */
c010585a:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010585d:	8b 50 04             	mov    0x4(%eax),%edx
c0105860:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105863:	89 50 04             	mov    %edx,0x4(%eax)
c0105866:	eb 3c                	jmp    c01058a4 <slob_alloc+0x12e>
			else { /* fragment */
				prev->next = cur + units;
c0105868:	8b 45 e0             	mov    -0x20(%ebp),%eax
c010586b:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
c0105872:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105875:	01 c2                	add    %eax,%edx
c0105877:	8b 45 f4             	mov    -0xc(%ebp),%eax
c010587a:	89 50 04             	mov    %edx,0x4(%eax)
				prev->next->units = cur->units - units;
c010587d:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105880:	8b 40 04             	mov    0x4(%eax),%eax
c0105883:	8b 55 f0             	mov    -0x10(%ebp),%edx
c0105886:	8b 12                	mov    (%edx),%edx
c0105888:	2b 55 e0             	sub    -0x20(%ebp),%edx
c010588b:	89 10                	mov    %edx,(%eax)
				prev->next->next = cur->next;
c010588d:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105890:	8b 40 04             	mov    0x4(%eax),%eax
c0105893:	8b 55 f0             	mov    -0x10(%ebp),%edx
c0105896:	8b 52 04             	mov    0x4(%edx),%edx
c0105899:	89 50 04             	mov    %edx,0x4(%eax)
				cur->units = units;
c010589c:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010589f:	8b 55 e0             	mov    -0x20(%ebp),%edx
c01058a2:	89 10                	mov    %edx,(%eax)
			}

			slobfree = prev;
c01058a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
c01058a7:	a3 08 7a 12 c0       	mov    %eax,0xc0127a08
			spin_unlock_irqrestore(&slob_lock, flags);
c01058ac:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c01058af:	83 ec 0c             	sub    $0xc,%esp
c01058b2:	50                   	push   %eax
c01058b3:	e8 3a fd ff ff       	call   c01055f2 <__intr_restore>
c01058b8:	83 c4 10             	add    $0x10,%esp
			return cur;
c01058bb:	8b 45 f0             	mov    -0x10(%ebp),%eax
c01058be:	e9 80 00 00 00       	jmp    c0105943 <slob_alloc+0x1cd>
		}
		if (cur == slobfree) {
c01058c3:	a1 08 7a 12 c0       	mov    0xc0127a08,%eax
c01058c8:	39 45 f0             	cmp    %eax,-0x10(%ebp)
c01058cb:	75 62                	jne    c010592f <slob_alloc+0x1b9>
			spin_unlock_irqrestore(&slob_lock, flags);
c01058cd:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c01058d0:	83 ec 0c             	sub    $0xc,%esp
c01058d3:	50                   	push   %eax
c01058d4:	e8 19 fd ff ff       	call   c01055f2 <__intr_restore>
c01058d9:	83 c4 10             	add    $0x10,%esp

			if (size == PAGE_SIZE) /* trying to shrink arena? */
c01058dc:	81 7d 08 00 10 00 00 	cmpl   $0x1000,0x8(%ebp)
c01058e3:	75 07                	jne    c01058ec <slob_alloc+0x176>
				return 0;
c01058e5:	b8 00 00 00 00       	mov    $0x0,%eax
c01058ea:	eb 57                	jmp    c0105943 <slob_alloc+0x1cd>

			cur = (slob_t *)__slob_get_free_page(gfp);
c01058ec:	83 ec 08             	sub    $0x8,%esp
c01058ef:	6a 00                	push   $0x0
c01058f1:	ff 75 0c             	pushl  0xc(%ebp)
c01058f4:	e8 04 fe ff ff       	call   c01056fd <__slob_get_free_pages>
c01058f9:	83 c4 10             	add    $0x10,%esp
c01058fc:	89 45 f0             	mov    %eax,-0x10(%ebp)
			if (!cur)
c01058ff:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
c0105903:	75 07                	jne    c010590c <slob_alloc+0x196>
				return 0;
c0105905:	b8 00 00 00 00       	mov    $0x0,%eax
c010590a:	eb 37                	jmp    c0105943 <slob_alloc+0x1cd>

			slob_free(cur, PAGE_SIZE);
c010590c:	83 ec 08             	sub    $0x8,%esp
c010590f:	68 00 10 00 00       	push   $0x1000
c0105914:	ff 75 f0             	pushl  -0x10(%ebp)
c0105917:	e8 29 00 00 00       	call   c0105945 <slob_free>
c010591c:	83 c4 10             	add    $0x10,%esp
			spin_lock_irqsave(&slob_lock, flags);
c010591f:	e8 a4 fc ff ff       	call   c01055c8 <__intr_save>
c0105924:	89 45 e4             	mov    %eax,-0x1c(%ebp)
			cur = slobfree;
c0105927:	a1 08 7a 12 c0       	mov    0xc0127a08,%eax
c010592c:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	prev = slobfree;
	for (cur = prev->next; ; prev = cur, cur = cur->next) {
c010592f:	8b 45 f0             	mov    -0x10(%ebp),%eax
...
c010593e:	e9 8f fe ff ff       	jmp    c01057d2 <slob_alloc+0x5c>
}
c0105943:	c9                   	leave  
c0105944:	c3                   	ret    
...
c010594e:	89 45 f0             	mov    %eax,-0x10(%ebp)
	unsigned long flags;

	if (!block)
c0105951:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
c0105955:	0f 84 05 01 00 00    	je     c0105a60 <slob_free+0x11b>
		return;

	if (size)
c010595b:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
c010595f:	74 10                	je     c0105971 <slob_free+0x2c>
		b->units = SLOB_UNITS(size);
c0105961:	8b 45 0c             	mov    0xc(%ebp),%eax
c0105964:	83 c0 07             	add    $0x7,%eax
c0105967:	c1 e8 03             	shr    $0x3,%eax
c010596a:	89 c2                	mov    %eax,%edx
c010596c:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010596f:	89 10                	mov    %edx,(%eax)

	/* Find reinsertion point */
	spin_lock_irqsave(&slob_lock, flags);
c0105971:	e8 52 fc ff ff       	call   c01055c8 <__intr_save>
c0105976:	89 45 ec             	mov    %eax,-0x14(%ebp)
	for (cur = slobfree; !(b > cur && b < cur->next); cur = cur->next)
c0105979:	a1 08 7a 12 c0       	mov    0xc0127a08,%eax
c010597e:	89 45 f4             	mov    %eax,-0xc(%ebp)
c0105981:	eb 27                	jmp    c01059aa <slob_free+0x65>
		if (cur >= cur->next && (b > cur || b < cur->next))
c0105983:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105986:	8b 40 04             	mov    0x4(%eax),%eax
c0105989:	3b 45 f4             	cmp    -0xc(%ebp),%eax
c010598c:	77 13                	ja     c01059a1 <slob_free+0x5c>
c010598e:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105991:	3b 45 f4             	cmp    -0xc(%ebp),%eax
c0105994:	77 27                	ja     c01059bd <slob_free+0x78>
c0105996:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105999:	8b 40 04             	mov    0x4(%eax),%eax
c010599c:	3b 45 f0             	cmp    -0x10(%ebp),%eax
c010599f:	77 1c                	ja     c01059bd <slob_free+0x78>
	if (size)
		b->units = SLOB_UNITS(size);
...
c01059a4:	8b 40 04             	mov    0x4(%eax),%eax
c01059a7:	89 45 f4             	mov    %eax,-0xc(%ebp)
c01059aa:	8b 45 f0             	mov    -0x10(%ebp),%eax
c01059ad:	3b 45 f4             	cmp    -0xc(%ebp),%eax
c01059b0:	76 d1                	jbe    c0105983 <slob_free+0x3e>
c01059b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
c01059b5:	8b 40 04             	mov    0x4(%eax),%eax
c01059b8:	3b 45 f0             	cmp    -0x10(%ebp),%eax
c01059bb:	76 c6                	jbe    c0105983 <slob_free+0x3e>
		if (cur >= cur->next && (b > cur || b < cur->next))
			break;
...
c01059c2:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
c01059c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
c01059cc:	01 c2                	add    %eax,%edx
c01059ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
c01059d1:	8b 40 04             	mov    0x4(%eax),%eax
c01059d4:	39 c2                	cmp    %eax,%edx
c01059d6:	75 25                	jne    c01059fd <slob_free+0xb8>
		b->units += cur->next->units;
c01059d8:	8b 45 f0             	mov    -0x10(%ebp),%eax
c01059db:	8b 10                	mov    (%eax),%edx
c01059dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
c01059e0:	8b 40 04             	mov    0x4(%eax),%eax
c01059e3:	8b 00                	mov    (%eax),%eax
c01059e5:	01 c2                	add    %eax,%edx
c01059e7:	8b 45 f0             	mov    -0x10(%ebp),%eax
c01059ea:	89 10                	mov    %edx,(%eax)
		b->next = cur->next->next;
c01059ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
c01059ef:	8b 40 04             	mov    0x4(%eax),%eax
c01059f2:	8b 50 04             	mov    0x4(%eax),%edx
c01059f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
c01059f8:	89 50 04             	mov    %edx,0x4(%eax)
c01059fb:	eb 0c                	jmp    c0105a09 <slob_free+0xc4>
	} else
		b->next = cur->next;
c01059fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105a00:	8b 50 04             	mov    0x4(%eax),%edx
...
c0105a0e:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
c0105a15:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105a18:	01 d0                	add    %edx,%eax
c0105a1a:	3b 45 f0             	cmp    -0x10(%ebp),%eax
c0105a1d:	75 1f                	jne    c0105a3e <slob_free+0xf9>
		cur->units += b->units;
c0105a1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105a22:	8b 10                	mov    (%eax),%edx
c0105a24:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105a27:	8b 00                	mov    (%eax),%eax
c0105a29:	01 c2                	add    %eax,%edx
c0105a2b:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105a2e:	89 10                	mov    %edx,(%eax)
		cur->next = b->next;
c0105a30:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105a33:	8b 50 04             	mov    0x4(%eax),%edx
c0105a36:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105a39:	89 50 04             	mov    %edx,0x4(%eax)
c0105a3c:	eb 09                	jmp    c0105a47 <slob_free+0x102>
	} else
		cur->next = b;
c0105a3e:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105a41:	8b 55 f0             	mov    -0x10(%ebp),%edx
c0105a44:	89 50 04             	mov    %edx,0x4(%eax)

	slobfree = cur;
c0105a47:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105a4a:	a3 08 7a 12 c0       	mov    %eax,0xc0127a08

	spin_unlock_irqrestore(&slob_lock, flags);
c0105a4f:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0105a52:	83 ec 0c             	sub    $0xc,%esp
c0105a55:	50                   	push   %eax
c0105a56:	e8 97 fb ff ff       	call   c01055f2 <__intr_restore>
c0105a5b:	83 c4 10             	add    $0x10,%esp
c0105a5e:	eb 01                	jmp    c0105a61 <slob_free+0x11c>
{
	slob_t *cur, *b = (slob_t *)block;
	unsigned long flags;
...
c0105a66:	83 ec 08             	sub    $0x8,%esp
  cprintf("check_slab() success\n");
c0105a69:	83 ec 0c             	sub    $0xc,%esp
c0105a6c:	68 06 bb 10 c0       	push   $0xc010bb06
c0105a71:	e8 14 a8 ff ff       	call   c010028a <cprintf>
c0105a76:	83 c4 10             	add    $0x10,%esp
}
c0105a79:	90                   	nop
c0105a7a:	c9                   	leave  
c0105a7b:	c3                   	ret    
...
c0105a82:	83 ec 0c             	sub    $0xc,%esp
c0105a85:	68 1c bb 10 c0       	push   $0xc010bb1c
c0105a8a:	e8 fb a7 ff ff       	call   c010028a <cprintf>
c0105a8f:	83 c4 10             	add    $0x10,%esp
  check_slab();
c0105a92:	e8 cc ff ff ff       	call   c0105a63 <check_slab>
}
c0105a97:	90                   	nop
c0105a98:	c9                   	leave  
c0105a99:	c3                   	ret    

c0105a9a <kmalloc_init>:

inline void 
kmalloc_init(void) {
c0105a9a:	55                   	push   %ebp
c0105a9b:	89 e5                	mov    %esp,%ebp
c0105a9d:	83 ec 08             	sub    $0x8,%esp
    slab_init();
c0105aa0:	e8 d7 ff ff ff       	call   c0105a7c <slab_init>
    cprintf("kmalloc_init() succeeded!\n");
c0105aa5:	83 ec 0c             	sub    $0xc,%esp
c0105aa8:	68 30 bb 10 c0       	push   $0xc010bb30
c0105aad:	e8 d8 a7 ff ff       	call   c010028a <cprintf>
c0105ab2:	83 c4 10             	add    $0x10,%esp
}
c0105ab5:	90                   	nop
c0105ab6:	c9                   	leave  
c0105ab7:	c3                   	ret    

c0105ab8 <slab_allocated>:
...
c0105ac5:	e8 ee ff ff ff       	call   c0105ab8 <slab_allocated>
}
c0105aca:	5d                   	pop    %ebp
c0105acb:	c3                   	ret    
...
{
c0105acc:	55                   	push   %ebp
c0105acd:	89 e5                	mov    %esp,%ebp
c0105acf:	83 ec 10             	sub    $0x10,%esp
	int order = 0;
c0105ad2:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	for ( ; size > 4096 ; size >>=1)
c0105ad9:	eb 07                	jmp    c0105ae2 <find_order+0x16>
		order++;
c0105adb:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
}
...
static int find_order(int size)
{
	int order = 0;
	for ( ; size > 4096 ; size >>=1)
c0105adf:	d1 7d 08             	sarl   0x8(%ebp)
c0105ae2:	81 7d 08 00 10 00 00 	cmpl   $0x1000,0x8(%ebp)
c0105ae9:	7f f0                	jg     c0105adb <find_order+0xf>
		order++;
	return order;
...
c0105af3:	83 ec 18             	sub    $0x18,%esp
	slob_t *m;
	bigblock_t *bb;
	unsigned long flags;

	if (size < PAGE_SIZE - SLOB_UNIT) {
c0105af6:	81 7d 08 f7 0f 00 00 	cmpl   $0xff7,0x8(%ebp)
c0105afd:	77 35                	ja     c0105b34 <__kmalloc+0x44>
		m = slob_alloc(size + SLOB_UNIT, gfp, 0);
c0105aff:	8b 45 08             	mov    0x8(%ebp),%eax
c0105b02:	83 c0 08             	add    $0x8,%eax
c0105b05:	83 ec 04             	sub    $0x4,%esp
c0105b08:	6a 00                	push   $0x0
c0105b0a:	ff 75 0c             	pushl  0xc(%ebp)
c0105b0d:	50                   	push   %eax
c0105b0e:	e8 63 fc ff ff       	call   c0105776 <slob_alloc>
c0105b13:	83 c4 10             	add    $0x10,%esp
c0105b16:	89 45 f4             	mov    %eax,-0xc(%ebp)
		return m ? (void *)(m + 1) : 0;
c0105b19:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
c0105b1d:	74 0b                	je     c0105b2a <__kmalloc+0x3a>
c0105b1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105b22:	83 c0 08             	add    $0x8,%eax
c0105b25:	e9 b3 00 00 00       	jmp    c0105bdd <__kmalloc+0xed>
c0105b2a:	b8 00 00 00 00       	mov    $0x0,%eax
c0105b2f:	e9 a9 00 00 00       	jmp    c0105bdd <__kmalloc+0xed>
	}

	bb = slob_alloc(sizeof(bigblock_t), gfp, 0);
c0105b34:	83 ec 04             	sub    $0x4,%esp
c0105b37:	6a 00                	push   $0x0
c0105b39:	ff 75 0c             	pushl  0xc(%ebp)
c0105b3c:	6a 0c                	push   $0xc
c0105b3e:	e8 33 fc ff ff       	call   c0105776 <slob_alloc>
c0105b43:	83 c4 10             	add    $0x10,%esp
c0105b46:	89 45 f0             	mov    %eax,-0x10(%ebp)
	if (!bb)
c0105b49:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
c0105b4d:	75 0a                	jne    c0105b59 <__kmalloc+0x69>
		return 0;
c0105b4f:	b8 00 00 00 00       	mov    $0x0,%eax
c0105b54:	e9 84 00 00 00       	jmp    c0105bdd <__kmalloc+0xed>

	bb->order = find_order(size);
c0105b59:	8b 45 08             	mov    0x8(%ebp),%eax
c0105b5c:	83 ec 0c             	sub    $0xc,%esp
c0105b5f:	50                   	push   %eax
c0105b60:	e8 67 ff ff ff       	call   c0105acc <find_order>
c0105b65:	83 c4 10             	add    $0x10,%esp
c0105b68:	89 c2                	mov    %eax,%edx
c0105b6a:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105b6d:	89 10                	mov    %edx,(%eax)
	bb->pages = (void *)__slob_get_free_pages(gfp, bb->order);
c0105b6f:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105b72:	8b 00                	mov    (%eax),%eax
c0105b74:	83 ec 08             	sub    $0x8,%esp
c0105b77:	50                   	push   %eax
c0105b78:	ff 75 0c             	pushl  0xc(%ebp)
c0105b7b:	e8 7d fb ff ff       	call   c01056fd <__slob_get_free_pages>
c0105b80:	83 c4 10             	add    $0x10,%esp
c0105b83:	89 c2                	mov    %eax,%edx
c0105b85:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105b88:	89 50 04             	mov    %edx,0x4(%eax)

	if (bb->pages) {
c0105b8b:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105b8e:	8b 40 04             	mov    0x4(%eax),%eax
c0105b91:	85 c0                	test   %eax,%eax
c0105b93:	74 33                	je     c0105bc8 <__kmalloc+0xd8>
		spin_lock_irqsave(&block_lock, flags);
c0105b95:	e8 2e fa ff ff       	call   c01055c8 <__intr_save>
c0105b9a:	89 45 ec             	mov    %eax,-0x14(%ebp)
		bb->next = bigblocks;
c0105b9d:	8b 15 68 af 12 c0    	mov    0xc012af68,%edx
c0105ba3:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105ba6:	89 50 08             	mov    %edx,0x8(%eax)
		bigblocks = bb;
c0105ba9:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105bac:	a3 68 af 12 c0       	mov    %eax,0xc012af68
		spin_unlock_irqrestore(&block_lock, flags);
c0105bb1:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0105bb4:	83 ec 0c             	sub    $0xc,%esp
c0105bb7:	50                   	push   %eax
c0105bb8:	e8 35 fa ff ff       	call   c01055f2 <__intr_restore>
c0105bbd:	83 c4 10             	add    $0x10,%esp
		return bb->pages;
c0105bc0:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105bc3:	8b 40 04             	mov    0x4(%eax),%eax
c0105bc6:	eb 15                	jmp    c0105bdd <__kmalloc+0xed>
	}

	slob_free(bb, sizeof(bigblock_t));
c0105bc8:	83 ec 08             	sub    $0x8,%esp
c0105bcb:	6a 0c                	push   $0xc
c0105bcd:	ff 75 f0             	pushl  -0x10(%ebp)
c0105bd0:	e8 70 fd ff ff       	call   c0105945 <slob_free>
c0105bd5:	83 c4 10             	add    $0x10,%esp
	return 0;
c0105bd8:	b8 00 00 00 00       	mov    $0x0,%eax
}
c0105bdd:	c9                   	leave  
c0105bde:	c3                   	ret    
...
c0105be2:	83 ec 08             	sub    $0x8,%esp
  return __kmalloc(size, 0);
c0105be5:	83 ec 08             	sub    $0x8,%esp
c0105be8:	6a 00                	push   $0x0
c0105bea:	ff 75 08             	pushl  0x8(%ebp)
c0105bed:	e8 fe fe ff ff       	call   c0105af0 <__kmalloc>
...
c0105bfd:	c7 45 f0 68 af 12 c0 	movl   $0xc012af68,-0x10(%ebp)
	unsigned long flags;

	if (!block)
c0105c04:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
c0105c08:	0f 84 ac 00 00 00    	je     c0105cba <kfree+0xc3>
		return;

	if (!((unsigned long)block & (PAGE_SIZE-1))) {
c0105c0e:	8b 45 08             	mov    0x8(%ebp),%eax
c0105c11:	25 ff 0f 00 00       	and    $0xfff,%eax
c0105c16:	85 c0                	test   %eax,%eax
c0105c18:	0f 85 85 00 00 00    	jne    c0105ca3 <kfree+0xac>
		/* might be on the big block list */
		spin_lock_irqsave(&block_lock, flags);
c0105c1e:	e8 a5 f9 ff ff       	call   c01055c8 <__intr_save>
c0105c23:	89 45 ec             	mov    %eax,-0x14(%ebp)
		for (bb = bigblocks; bb; last = &bb->next, bb = bb->next) {
c0105c26:	a1 68 af 12 c0       	mov    0xc012af68,%eax
c0105c2b:	89 45 f4             	mov    %eax,-0xc(%ebp)
c0105c2e:	eb 5e                	jmp    c0105c8e <kfree+0x97>
			if (bb->pages == block) {
c0105c30:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105c33:	8b 40 04             	mov    0x4(%eax),%eax
c0105c36:	3b 45 08             	cmp    0x8(%ebp),%eax
c0105c39:	75 41                	jne    c0105c7c <kfree+0x85>
				*last = bb->next;
c0105c3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105c3e:	8b 50 08             	mov    0x8(%eax),%edx
c0105c41:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105c44:	89 10                	mov    %edx,(%eax)
				spin_unlock_irqrestore(&block_lock, flags);
c0105c46:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0105c49:	83 ec 0c             	sub    $0xc,%esp
c0105c4c:	50                   	push   %eax
c0105c4d:	e8 a0 f9 ff ff       	call   c01055f2 <__intr_restore>
c0105c52:	83 c4 10             	add    $0x10,%esp
				__slob_free_pages((unsigned long)block, bb->order);
c0105c55:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105c58:	8b 10                	mov    (%eax),%edx
c0105c5a:	8b 45 08             	mov    0x8(%ebp),%eax
c0105c5d:	83 ec 08             	sub    $0x8,%esp
c0105c60:	52                   	push   %edx
c0105c61:	50                   	push   %eax
c0105c62:	e8 d6 fa ff ff       	call   c010573d <__slob_free_pages>
c0105c67:	83 c4 10             	add    $0x10,%esp
				slob_free(bb, sizeof(bigblock_t));
c0105c6a:	83 ec 08             	sub    $0x8,%esp
c0105c6d:	6a 0c                	push   $0xc
c0105c6f:	ff 75 f4             	pushl  -0xc(%ebp)
c0105c72:	e8 ce fc ff ff       	call   c0105945 <slob_free>
c0105c77:	83 c4 10             	add    $0x10,%esp
				return;
c0105c7a:	eb 3f                	jmp    c0105cbb <kfree+0xc4>
		return;
	...
	if (!((unsigned long)block & (PAGE_SIZE-1))) {
		...
		spin_lock_irqsave(&block_lock, flags);
		for (bb = bigblocks; bb; last = &bb->next, bb = bb->next) {
c0105c7c:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105c7f:	83 c0 08             	add    $0x8,%eax
c0105c82:	89 45 f0             	mov    %eax,-0x10(%ebp)
c0105c85:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105c88:	8b 40 08             	mov    0x8(%eax),%eax
c0105c8b:	89 45 f4             	mov    %eax,-0xc(%ebp)
c0105c8e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
c0105c92:	75 9c                	jne    c0105c30 <kfree+0x39>
				__slob_free_pages((unsigned long)block, bb->order);
				slob_free(bb, sizeof(bigblock_t));
				return;
			}
		...
		spin_unlock_irqrestore(&block_lock, flags);
c0105c94:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0105c97:	83 ec 0c             	sub    $0xc,%esp
c0105c9a:	50                   	push   %eax
c0105c9b:	e8 52 f9 ff ff       	call   c01055f2 <__intr_restore>
c0105ca0:	83 c4 10             	add    $0x10,%esp
	}

	slob_free((slob_t *)block - 1, 0);
c0105ca3:	8b 45 08             	mov    0x8(%ebp),%eax
c0105ca6:	83 e8 08             	sub    $0x8,%eax
c0105ca9:	83 ec 08             	sub    $0x8,%esp
c0105cac:	6a 00                	push   $0x0
c0105cae:	50                   	push   %eax
c0105caf:	e8 91 fc ff ff       	call   c0105945 <slob_free>
c0105cb4:	83 c4 10             	add    $0x10,%esp
	return;
c0105cb7:	90                   	nop
c0105cb8:	eb 01                	jmp    c0105cbb <kfree+0xc4>
{
	bigblock_t *bb, **last = &bigblocks;
	unsigned long flags;
...
c0105cc0:	83 ec 18             	sub    $0x18,%esp
	...
	if (!block)
c0105cc3:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
c0105cc7:	75 07                	jne    c0105cd0 <ksize+0x13>
		return 0;
c0105cc9:	b8 00 00 00 00       	mov    $0x0,%eax
c0105cce:	eb 73                	jmp    c0105d43 <ksize+0x86>

	if (!((unsigned long)block & (PAGE_SIZE-1))) {
c0105cd0:	8b 45 08             	mov    0x8(%ebp),%eax
c0105cd3:	25 ff 0f 00 00       	and    $0xfff,%eax
c0105cd8:	85 c0                	test   %eax,%eax
c0105cda:	75 5c                	jne    c0105d38 <ksize+0x7b>
		spin_lock_irqsave(&block_lock, flags);
c0105cdc:	e8 e7 f8 ff ff       	call   c01055c8 <__intr_save>
c0105ce1:	89 45 f0             	mov    %eax,-0x10(%ebp)
		for (bb = bigblocks; bb; bb = bb->next)
c0105ce4:	a1 68 af 12 c0       	mov    0xc012af68,%eax
c0105ce9:	89 45 f4             	mov    %eax,-0xc(%ebp)
c0105cec:	eb 35                	jmp    c0105d23 <ksize+0x66>
			if (bb->pages == block) {
c0105cee:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105cf1:	8b 40 04             	mov    0x4(%eax),%eax
c0105cf4:	3b 45 08             	cmp    0x8(%ebp),%eax
c0105cf7:	75 21                	jne    c0105d1a <ksize+0x5d>
				spin_unlock_irqrestore(&slob_lock, flags);
c0105cf9:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0105cfc:	83 ec 0c             	sub    $0xc,%esp
c0105cff:	50                   	push   %eax
c0105d00:	e8 ed f8 ff ff       	call   c01055f2 <__intr_restore>
c0105d05:	83 c4 10             	add    $0x10,%esp
				return PAGE_SIZE << bb->order;
c0105d08:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0105d0b:	8b 00                	mov    (%eax),%eax
c0105d0d:	ba 00 10 00 00       	mov    $0x1000,%edx
c0105d12:	89 c1                	mov    %eax,%ecx
c0105d14:	d3 e2                	shl    %cl,%edx
c0105d16:	89 d0                	mov    %edx,%eax
c0105d18:	eb 29                	jmp    c0105d43 <ksize+0x86>
	if (!block)
		return 0;
...
c0105d1d:	8b 40 08             	mov    0x8(%eax),%eax
c0105d20:	89 45 f4             	mov    %eax,-0xc(%ebp)
c0105d23:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
c0105d27:	75 c5                	jne    c0105cee <ksize+0x31>
			if (bb->pages == block) {
				spin_unlock_irqrestore(&slob_lock, flags);
				return PAGE_SIZE << bb->order;
			}
...
c0105d2c:	83 ec 0c             	sub    $0xc,%esp
c0105d2f:	50                   	push   %eax
c0105d30:	e8 bd f8 ff ff       	call   c01055f2 <__intr_restore>
c0105d35:	83 c4 10             	add    $0x10,%esp
	}

	return ((slob_t *)block - 1)->units * SLOB_UNIT;
c0105d38:	8b 45 08             	mov    0x8(%ebp),%eax
c0105d3b:	83 e8 08             	sub    $0x8,%eax
c0105d3e:	8b 00                	mov    (%eax),%eax
c0105d40:	c1 e0 03             	shl    $0x3,%eax
}
c0105d43:	c9                   	leave  
c0105d44:	c3                   	ret    
...
c0105d48:	83 ec 08             	sub    $0x8,%esp
    if (PPN(pa) >= npage) {
c0105d4b:	8b 45 08             	mov    0x8(%ebp),%eax
c0105d4e:	c1 e8 0c             	shr    $0xc,%eax
c0105d51:	89 c2                	mov    %eax,%edx
c0105d53:	a1 80 af 12 c0       	mov    0xc012af80,%eax
c0105d58:	39 c2                	cmp    %eax,%edx
c0105d5a:	72 14                	jb     c0105d70 <pa2page+0x2b>
        panic("pa2page called with invalid pa");
c0105d5c:	83 ec 04             	sub    $0x4,%esp
c0105d5f:	68 4c bb 10 c0       	push   $0xc010bb4c
c0105d64:	6a 5f                	push   $0x5f
c0105d66:	68 6b bb 10 c0       	push   $0xc010bb6b
c0105d6b:	e8 f8 b9 ff ff       	call   c0101768 <__panic>
    }
    return &pages[PPN(pa)];
c0105d70:	8b 0d 58 d1 12 c0    	mov    0xc012d158,%ecx
c0105d76:	8b 45 08             	mov    0x8(%ebp),%eax
c0105d79:	c1 e8 0c             	shr    $0xc,%eax
c0105d7c:	89 c2                	mov    %eax,%edx
c0105d7e:	89 d0                	mov    %edx,%eax
c0105d80:	c1 e0 03             	shl    $0x3,%eax
c0105d83:	01 d0                	add    %edx,%eax
c0105d85:	c1 e0 02             	shl    $0x2,%eax
c0105d88:	01 c8                	add    %ecx,%eax
}
c0105d8a:	c9                   	leave  
c0105d8b:	c3                   	ret    
...
c0105d95:	83 e0 01             	and    $0x1,%eax
c0105d98:	85 c0                	test   %eax,%eax
c0105d9a:	75 14                	jne    c0105db0 <pte2page+0x24>
        panic("pte2page called with invalid pte");
c0105d9c:	83 ec 04             	sub    $0x4,%esp
c0105d9f:	68 7c bb 10 c0       	push   $0xc010bb7c
c0105da4:	6a 71                	push   $0x71
c0105da6:	68 6b bb 10 c0       	push   $0xc010bb6b
c0105dab:	e8 b8 b9 ff ff       	call   c0101768 <__panic>
    }
    return pa2page(PTE_ADDR(pte));
c0105db0:	8b 45 08             	mov    0x8(%ebp),%eax
c0105db3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
c0105db8:	83 ec 0c             	sub    $0xc,%esp
c0105dbb:	50                   	push   %eax
c0105dbc:	e8 84 ff ff ff       	call   c0105d45 <pa2page>
...
c0105dc9:	83 ec 18             	sub    $0x18,%esp
     swapfs_init();
c0105dcc:	e8 cb 32 00 00       	call   c010909c <swapfs_init>

     if (!(1024 <= max_swap_offset && max_swap_offset < MAX_SWAP_OFFSET_LIMIT))
c0105dd1:	a1 1c d1 12 c0       	mov    0xc012d11c,%eax
c0105dd6:	3d ff 03 00 00       	cmp    $0x3ff,%eax
c0105ddb:	76 0c                	jbe    c0105de9 <swap_init+0x23>
c0105ddd:	a1 1c d1 12 c0       	mov    0xc012d11c,%eax
c0105de2:	3d ff ff ff 00       	cmp    $0xffffff,%eax
c0105de7:	76 17                	jbe    c0105e00 <swap_init+0x3a>
     {
          panic("bad max_swap_offset %08x.\n", max_swap_offset);
c0105de9:	a1 1c d1 12 c0       	mov    0xc012d11c,%eax
c0105dee:	50                   	push   %eax
c0105def:	68 9d bb 10 c0       	push   $0xc010bb9d
c0105df4:	6a 25                	push   $0x25
c0105df6:	68 b8 bb 10 c0       	push   $0xc010bbb8
c0105dfb:	e8 68 b9 ff ff       	call   c0101768 <__panic>
     }
     

     sm = &swap_manager_fifo;
c0105e00:	c7 05 74 af 12 c0 e0 	movl   $0xc01279e0,0xc012af74
c0105e07:	79 12 c0 
     int r = sm->init();
c0105e0a:	a1 74 af 12 c0       	mov    0xc012af74,%eax
c0105e0f:	8b 40 04             	mov    0x4(%eax),%eax
c0105e12:	ff d0                	call   *%eax
c0105e14:	89 45 f4             	mov    %eax,-0xc(%ebp)
     
     if (r == 0)
c0105e17:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
c0105e1b:	75 27                	jne    c0105e44 <swap_init+0x7e>
     {
          swap_init_ok = 1;
c0105e1d:	c7 05 6c af 12 c0 01 	movl   $0x1,0xc012af6c
c0105e24:	00 00 00 
          cprintf("SWAP: manager = %s\n", sm->name);
c0105e27:	a1 74 af 12 c0       	mov    0xc012af74,%eax
c0105e2c:	8b 00                	mov    (%eax),%eax
c0105e2e:	83 ec 08             	sub    $0x8,%esp
c0105e31:	50                   	push   %eax
c0105e32:	68 c7 bb 10 c0       	push   $0xc010bbc7
c0105e37:	e8 4e a4 ff ff       	call   c010028a <cprintf>
c0105e3c:	83 c4 10             	add    $0x10,%esp
          check_swap();
c0105e3f:	e8 f7 03 00 00       	call   c010623b <check_swap>
     }
...
c0105e4c:	83 ec 08             	sub    $0x8,%esp
     return sm->init_mm(mm);
c0105e4f:	a1 74 af 12 c0       	mov    0xc012af74,%eax
c0105e54:	8b 40 08             	mov    0x8(%eax),%eax
c0105e57:	83 ec 0c             	sub    $0xc,%esp
c0105e5a:	ff 75 08             	pushl  0x8(%ebp)
c0105e5d:	ff d0                	call   *%eax
c0105e5f:	83 c4 10             	add    $0x10,%esp
}
c0105e62:	c9                   	leave  
c0105e63:	c3                   	ret    

c0105e64 <swap_tick_event>:
...
c0105e67:	83 ec 08             	sub    $0x8,%esp
     return sm->tick_event(mm);
c0105e6a:	a1 74 af 12 c0       	mov    0xc012af74,%eax
c0105e6f:	8b 40 0c             	mov    0xc(%eax),%eax
c0105e72:	83 ec 0c             	sub    $0xc,%esp
c0105e75:	ff 75 08             	pushl  0x8(%ebp)
c0105e78:	ff d0                	call   *%eax
c0105e7a:	83 c4 10             	add    $0x10,%esp
}
c0105e7d:	c9                   	leave  
c0105e7e:	c3                   	ret    

c0105e7f <swap_map_swappable>:
...
c0105e82:	83 ec 08             	sub    $0x8,%esp
     return sm->map_swappable(mm, addr, page, swap_in);
c0105e85:	a1 74 af 12 c0       	mov    0xc012af74,%eax
c0105e8a:	8b 40 10             	mov    0x10(%eax),%eax
c0105e8d:	ff 75 14             	pushl  0x14(%ebp)
c0105e90:	ff 75 10             	pushl  0x10(%ebp)
c0105e93:	ff 75 0c             	pushl  0xc(%ebp)
c0105e96:	ff 75 08             	pushl  0x8(%ebp)
c0105e99:	ff d0                	call   *%eax
c0105e9b:	83 c4 10             	add    $0x10,%esp
}
c0105e9e:	c9                   	leave  
c0105e9f:	c3                   	ret    

c0105ea0 <swap_set_unswappable>:
...
c0105ea3:	83 ec 08             	sub    $0x8,%esp
     return sm->set_unswappable(mm, addr);
c0105ea6:	a1 74 af 12 c0       	mov    0xc012af74,%eax
c0105eab:	8b 40 14             	mov    0x14(%eax),%eax
c0105eae:	83 ec 08             	sub    $0x8,%esp
c0105eb1:	ff 75 0c             	pushl  0xc(%ebp)
c0105eb4:	ff 75 08             	pushl  0x8(%ebp)
c0105eb7:	ff d0                	call   *%eax
...
{
c0105ebe:	55                   	push   %ebp
c0105ebf:	89 e5                	mov    %esp,%ebp
c0105ec1:	83 ec 28             	sub    $0x28,%esp
     int i;
     for (i = 0; i != n; ++ i)
c0105ec4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
c0105ecb:	e9 2e 01 00 00       	jmp    c0105ffe <swap_out+0x140>
     {
          uintptr_t v;
...
c0105ed0:	a1 74 af 12 c0       	mov    0xc012af74,%eax
c0105ed5:	8b 40 18             	mov    0x18(%eax),%eax
c0105ed8:	83 ec 04             	sub    $0x4,%esp
c0105edb:	ff 75 10             	pushl  0x10(%ebp)
c0105ede:	8d 55 e4             	lea    -0x1c(%ebp),%edx
c0105ee1:	52                   	push   %edx
c0105ee2:	ff 75 08             	pushl  0x8(%ebp)
c0105ee5:	ff d0                	call   *%eax
c0105ee7:	83 c4 10             	add    $0x10,%esp
c0105eea:	89 45 f0             	mov    %eax,-0x10(%ebp)
          if (r != 0) {
c0105eed:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
c0105ef1:	74 18                	je     c0105f0b <swap_out+0x4d>
                    cprintf("i %d, swap_out: call swap_out_victim failed\n",i);
c0105ef3:	83 ec 08             	sub    $0x8,%esp
c0105ef6:	ff 75 f4             	pushl  -0xc(%ebp)
c0105ef9:	68 dc bb 10 c0       	push   $0xc010bbdc
c0105efe:	e8 87 a3 ff ff       	call   c010028a <cprintf>
c0105f03:	83 c4 10             	add    $0x10,%esp
c0105f06:	e9 ff 00 00 00       	jmp    c010600a <swap_out+0x14c>
          }          
          ...
          v=page->pra_vaddr; 
c0105f0b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c0105f0e:	8b 40 20             	mov    0x20(%eax),%eax
...
c0105f1d:	6a 00                	push   $0x0
c0105f1f:	ff 75 ec             	pushl  -0x14(%ebp)
c0105f22:	50                   	push   %eax
c0105f23:	e8 69 22 00 00       	call   c0108191 <get_pte>
c0105f28:	83 c4 10             	add    $0x10,%esp
c0105f2b:	89 45 e8             	mov    %eax,-0x18(%ebp)
          assert((*ptep & PTE_P) != 0);
c0105f2e:	8b 45 e8             	mov    -0x18(%ebp),%eax
c0105f31:	8b 00                	mov    (%eax),%eax
c0105f33:	83 e0 01             	and    $0x1,%eax
c0105f36:	85 c0                	test   %eax,%eax
c0105f38:	75 16                	jne    c0105f50 <swap_out+0x92>
c0105f3a:	68 09 bc 10 c0       	push   $0xc010bc09
c0105f3f:	68 1e bc 10 c0       	push   $0xc010bc1e
c0105f44:	6a 65                	push   $0x65
c0105f46:	68 b8 bb 10 c0       	push   $0xc010bbb8
c0105f4b:	e8 18 b8 ff ff       	call   c0101768 <__panic>

          if (swapfs_write( (page->pra_vaddr/PGSIZE+1)<<8, page) != 0) {
c0105f50:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c0105f53:	8b 55 e4             	mov    -0x1c(%ebp),%edx
c0105f56:	8b 52 20             	mov    0x20(%edx),%edx
c0105f59:	c1 ea 0c             	shr    $0xc,%edx
c0105f5c:	83 c2 01             	add    $0x1,%edx
c0105f5f:	c1 e2 08             	shl    $0x8,%edx
c0105f62:	83 ec 08             	sub    $0x8,%esp
c0105f65:	50                   	push   %eax
c0105f66:	52                   	push   %edx
c0105f67:	e8 cc 31 00 00       	call   c0109138 <swapfs_write>
c0105f6c:	83 c4 10             	add    $0x10,%esp
c0105f6f:	85 c0                	test   %eax,%eax
c0105f71:	74 2b                	je     c0105f9e <swap_out+0xe0>
                    cprintf("SWAP: failed to save\n");
c0105f73:	83 ec 0c             	sub    $0xc,%esp
c0105f76:	68 33 bc 10 c0       	push   $0xc010bc33
c0105f7b:	e8 0a a3 ff ff       	call   c010028a <cprintf>
c0105f80:	83 c4 10             	add    $0x10,%esp
                    sm->map_swappable(mm, v, page, 0);
c0105f83:	a1 74 af 12 c0       	mov    0xc012af74,%eax
c0105f88:	8b 40 10             	mov    0x10(%eax),%eax
c0105f8b:	8b 55 e4             	mov    -0x1c(%ebp),%edx
c0105f8e:	6a 00                	push   $0x0
c0105f90:	52                   	push   %edx
c0105f91:	ff 75 ec             	pushl  -0x14(%ebp)
c0105f94:	ff 75 08             	pushl  0x8(%ebp)
c0105f97:	ff d0                	call   *%eax
c0105f99:	83 c4 10             	add    $0x10,%esp
c0105f9c:	eb 5c                	jmp    c0105ffa <swap_out+0x13c>
                    continue;
          }
          else {
                    cprintf("swap_out: i %d, store page in vaddr 0x%x to disk swap entry %d\n", i, v, page->pra_vaddr/PGSIZE+1);
c0105f9e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c0105fa1:	8b 40 20             	mov    0x20(%eax),%eax
c0105fa4:	c1 e8 0c             	shr    $0xc,%eax
c0105fa7:	83 c0 01             	add    $0x1,%eax
c0105faa:	50                   	push   %eax
c0105fab:	ff 75 ec             	pushl  -0x14(%ebp)
c0105fae:	ff 75 f4             	pushl  -0xc(%ebp)
c0105fb1:	68 4c bc 10 c0       	push   $0xc010bc4c
c0105fb6:	e8 cf a2 ff ff       	call   c010028a <cprintf>
c0105fbb:	83 c4 10             	add    $0x10,%esp
                    *ptep = (page->pra_vaddr/PGSIZE+1)<<8;
c0105fbe:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c0105fc1:	8b 40 20             	mov    0x20(%eax),%eax
c0105fc4:	c1 e8 0c             	shr    $0xc,%eax
c0105fc7:	83 c0 01             	add    $0x1,%eax
c0105fca:	c1 e0 08             	shl    $0x8,%eax
c0105fcd:	89 c2                	mov    %eax,%edx
c0105fcf:	8b 45 e8             	mov    -0x18(%ebp),%eax
c0105fd2:	89 10                	mov    %edx,(%eax)
                    free_page(page);
c0105fd4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c0105fd7:	83 ec 08             	sub    $0x8,%esp
c0105fda:	6a 01                	push   $0x1
c0105fdc:	50                   	push   %eax
c0105fdd:	e8 9f 1b 00 00       	call   c0107b81 <free_pages>
...
c0105fee:	ff 75 ec             	pushl  -0x14(%ebp)
c0105ff1:	50                   	push   %eax
c0105ff2:	e8 64 24 00 00       	call   c010845b <tlb_invalidate>
c0105ff7:	83 c4 10             	add    $0x10,%esp
...
swap_out(struct mm_struct *mm, int n, int in_tick)
{
     int i;
     for (i = 0; i != n; ++ i)
c0105ffa:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
c0105ffe:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0106001:	3b 45 0c             	cmp    0xc(%ebp),%eax
c0106004:	0f 85 c6 fe ff ff    	jne    c0105ed0 <swap_out+0x12>
                    free_page(page);
          }
     ...
     return i;
c010600a:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
c010600d:	c9                   	leave  
c010600e:	c3                   	ret    
...
c0106012:	83 ec 18             	sub    $0x18,%esp
     struct Page *result = alloc_page();
c0106015:	83 ec 0c             	sub    $0xc,%esp
c0106018:	6a 01                	push   $0x1
c010601a:	e8 f6 1a 00 00       	call   c0107b15 <alloc_pages>
c010601f:	83 c4 10             	add    $0x10,%esp
c0106022:	89 45 f4             	mov    %eax,-0xc(%ebp)
     assert(result!=NULL);
c0106025:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
c0106029:	75 16                	jne    c0106041 <swap_in+0x32>
c010602b:	68 8c bc 10 c0       	push   $0xc010bc8c
c0106030:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106035:	6a 7b                	push   $0x7b
c0106037:	68 b8 bb 10 c0       	push   $0xc010bbb8
c010603c:	e8 27 b7 ff ff       	call   c0101768 <__panic>

     pte_t *ptep = get_pte(mm->pgdir, addr, 0);
c0106041:	8b 45 08             	mov    0x8(%ebp),%eax
c0106044:	8b 40 0c             	mov    0xc(%eax),%eax
c0106047:	83 ec 04             	sub    $0x4,%esp
c010604a:	6a 00                	push   $0x0
c010604c:	ff 75 0c             	pushl  0xc(%ebp)
c010604f:	50                   	push   %eax
c0106050:	e8 3c 21 00 00       	call   c0108191 <get_pte>
c0106055:	83 c4 10             	add    $0x10,%esp
c0106058:	89 45 f0             	mov    %eax,-0x10(%ebp)
     // cprintf("SWAP: load ptep %x swap entry %d to vaddr 0x%08x, page %x, No %d\n", ptep, (*ptep)>>8, addr, result, (result-pages));
    
     int r;
     if ((r = swapfs_read((*ptep), result)) != 0)
c010605b:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010605e:	8b 00                	mov    (%eax),%eax
c0106060:	83 ec 08             	sub    $0x8,%esp
c0106063:	ff 75 f4             	pushl  -0xc(%ebp)
c0106066:	50                   	push   %eax
c0106067:	e8 73 30 00 00       	call   c01090df <swapfs_read>
c010606c:	83 c4 10             	add    $0x10,%esp
c010606f:	89 45 ec             	mov    %eax,-0x14(%ebp)
c0106072:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
c0106076:	74 1f                	je     c0106097 <swap_in+0x88>
     {
        assert(r!=0);
c0106078:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
c010607c:	75 19                	jne    c0106097 <swap_in+0x88>
c010607e:	68 99 bc 10 c0       	push   $0xc010bc99
c0106083:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106088:	68 83 00 00 00       	push   $0x83
c010608d:	68 b8 bb 10 c0       	push   $0xc010bbb8
c0106092:	e8 d1 b6 ff ff       	call   c0101768 <__panic>
     }
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
c0106097:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010609a:	8b 00                	mov    (%eax),%eax
c010609c:	c1 e8 08             	shr    $0x8,%eax
c010609f:	83 ec 04             	sub    $0x4,%esp
c01060a2:	ff 75 0c             	pushl  0xc(%ebp)
c01060a5:	50                   	push   %eax
c01060a6:	68 a0 bc 10 c0       	push   $0xc010bca0
c01060ab:	e8 da a1 ff ff       	call   c010028a <cprintf>
c01060b0:	83 c4 10             	add    $0x10,%esp
     *ptr_result=result;
c01060b3:	8b 45 10             	mov    0x10(%ebp),%eax
c01060b6:	8b 55 f4             	mov    -0xc(%ebp),%edx
c01060b9:	89 10                	mov    %edx,(%eax)
     return 0;
c01060bb:	b8 00 00 00 00       	mov    $0x0,%eax
}
c01060c0:	c9                   	leave  
c01060c1:	c3                   	ret    

c01060c2 <check_content_set>:
...
{
c01060c2:	55                   	push   %ebp
c01060c3:	89 e5                	mov    %esp,%ebp
c01060c5:	83 ec 08             	sub    $0x8,%esp
     *(unsigned char *)0x1000 = 0x0a;
c01060c8:	b8 00 10 00 00       	mov    $0x1000,%eax
c01060cd:	c6 00 0a             	movb   $0xa,(%eax)
     assert(pgfault_num==1);
c01060d0:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c01060d5:	83 f8 01             	cmp    $0x1,%eax
c01060d8:	74 19                	je     c01060f3 <check_content_set+0x31>
c01060da:	68 de bc 10 c0       	push   $0xc010bcde
c01060df:	68 1e bc 10 c0       	push   $0xc010bc1e
c01060e4:	68 90 00 00 00       	push   $0x90
c01060e9:	68 b8 bb 10 c0       	push   $0xc010bbb8
c01060ee:	e8 75 b6 ff ff       	call   c0101768 <__panic>
     *(unsigned char *)0x1010 = 0x0a;
c01060f3:	b8 10 10 00 00       	mov    $0x1010,%eax
c01060f8:	c6 00 0a             	movb   $0xa,(%eax)
     assert(pgfault_num==1);
c01060fb:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c0106100:	83 f8 01             	cmp    $0x1,%eax
c0106103:	74 19                	je     c010611e <check_content_set+0x5c>
c0106105:	68 de bc 10 c0       	push   $0xc010bcde
c010610a:	68 1e bc 10 c0       	push   $0xc010bc1e
c010610f:	68 92 00 00 00       	push   $0x92
c0106114:	68 b8 bb 10 c0       	push   $0xc010bbb8
c0106119:	e8 4a b6 ff ff       	call   c0101768 <__panic>
     *(unsigned char *)0x2000 = 0x0b;
c010611e:	b8 00 20 00 00       	mov    $0x2000,%eax
c0106123:	c6 00 0b             	movb   $0xb,(%eax)
     assert(pgfault_num==2);
c0106126:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c010612b:	83 f8 02             	cmp    $0x2,%eax
c010612e:	74 19                	je     c0106149 <check_content_set+0x87>
c0106130:	68 ed bc 10 c0       	push   $0xc010bced
c0106135:	68 1e bc 10 c0       	push   $0xc010bc1e
c010613a:	68 94 00 00 00       	push   $0x94
c010613f:	68 b8 bb 10 c0       	push   $0xc010bbb8
c0106144:	e8 1f b6 ff ff       	call   c0101768 <__panic>
     *(unsigned char *)0x2010 = 0x0b;
c0106149:	b8 10 20 00 00       	mov    $0x2010,%eax
c010614e:	c6 00 0b             	movb   $0xb,(%eax)
     assert(pgfault_num==2);
c0106151:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c0106156:	83 f8 02             	cmp    $0x2,%eax
c0106159:	74 19                	je     c0106174 <check_content_set+0xb2>
c010615b:	68 ed bc 10 c0       	push   $0xc010bced
c0106160:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106165:	68 96 00 00 00       	push   $0x96
c010616a:	68 b8 bb 10 c0       	push   $0xc010bbb8
c010616f:	e8 f4 b5 ff ff       	call   c0101768 <__panic>
     *(unsigned char *)0x3000 = 0x0c;
c0106174:	b8 00 30 00 00       	mov    $0x3000,%eax
c0106179:	c6 00 0c             	movb   $0xc,(%eax)
     assert(pgfault_num==3);
c010617c:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c0106181:	83 f8 03             	cmp    $0x3,%eax
c0106184:	74 19                	je     c010619f <check_content_set+0xdd>
c0106186:	68 fc bc 10 c0       	push   $0xc010bcfc
c010618b:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106190:	68 98 00 00 00       	push   $0x98
c0106195:	68 b8 bb 10 c0       	push   $0xc010bbb8
c010619a:	e8 c9 b5 ff ff       	call   c0101768 <__panic>
     *(unsigned char *)0x3010 = 0x0c;
c010619f:	b8 10 30 00 00       	mov    $0x3010,%eax
c01061a4:	c6 00 0c             	movb   $0xc,(%eax)
     assert(pgfault_num==3);
c01061a7:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c01061ac:	83 f8 03             	cmp    $0x3,%eax
c01061af:	74 19                	je     c01061ca <check_content_set+0x108>
c01061b1:	68 fc bc 10 c0       	push   $0xc010bcfc
c01061b6:	68 1e bc 10 c0       	push   $0xc010bc1e
c01061bb:	68 9a 00 00 00       	push   $0x9a
c01061c0:	68 b8 bb 10 c0       	push   $0xc010bbb8
c01061c5:	e8 9e b5 ff ff       	call   c0101768 <__panic>
     *(unsigned char *)0x4000 = 0x0d;
c01061ca:	b8 00 40 00 00       	mov    $0x4000,%eax
c01061cf:	c6 00 0d             	movb   $0xd,(%eax)
     assert(pgfault_num==4);
c01061d2:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c01061d7:	83 f8 04             	cmp    $0x4,%eax
c01061da:	74 19                	je     c01061f5 <check_content_set+0x133>
c01061dc:	68 0b bd 10 c0       	push   $0xc010bd0b
c01061e1:	68 1e bc 10 c0       	push   $0xc010bc1e
c01061e6:	68 9c 00 00 00       	push   $0x9c
c01061eb:	68 b8 bb 10 c0       	push   $0xc010bbb8
c01061f0:	e8 73 b5 ff ff       	call   c0101768 <__panic>
     *(unsigned char *)0x4010 = 0x0d;
c01061f5:	b8 10 40 00 00       	mov    $0x4010,%eax
c01061fa:	c6 00 0d             	movb   $0xd,(%eax)
     assert(pgfault_num==4);
c01061fd:	a1 64 af 12 c0       	mov    0xc012af64,%eax
c0106202:	83 f8 04             	cmp    $0x4,%eax
c0106205:	74 19                	je     c0106220 <check_content_set+0x15e>
c0106207:	68 0b bd 10 c0       	push   $0xc010bd0b
c010620c:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106211:	68 9e 00 00 00       	push   $0x9e
c0106216:	68 b8 bb 10 c0       	push   $0xc010bbb8
c010621b:	e8 48 b5 ff ff       	call   c0101768 <__panic>
}
c0106220:	90                   	nop
c0106221:	c9                   	leave  
c0106222:	c3                   	ret    

c0106223 <check_content_access>:
...
c0106229:	a1 74 af 12 c0       	mov    0xc012af74,%eax
c010622e:	8b 40 1c             	mov    0x1c(%eax),%eax
c0106231:	ff d0                	call   *%eax
c0106233:	89 45 f4             	mov    %eax,-0xc(%ebp)
    return ret;
...
c010623e:	83 ec 68             	sub    $0x68,%esp
    //backup mem env
     int ret, count = 0, total = 0, i;
c0106241:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
c0106248:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
     list_entry_t *le = &free_list;
c010624f:	c7 45 e8 44 d1 12 c0 	movl   $0xc012d144,-0x18(%ebp)
     while ((le = list_next(le)) != &free_list) {
c0106256:	eb 60                	jmp    c01062b8 <check_swap+0x7d>
        struct Page *p = le2page(le, page_link);
c0106258:	8b 45 e8             	mov    -0x18(%ebp),%eax
c010625b:	83 e8 10             	sub    $0x10,%eax
c010625e:	89 45 e0             	mov    %eax,-0x20(%ebp)
        assert(PageProperty(p));
c0106261:	8b 45 e0             	mov    -0x20(%ebp),%eax
c0106264:	83 c0 04             	add    $0x4,%eax
c0106267:	c7 45 b0 01 00 00 00 	movl   $0x1,-0x50(%ebp)
c010626e:	89 45 ac             	mov    %eax,-0x54(%ebp)
...
c0106271:	8b 45 ac             	mov    -0x54(%ebp),%eax
c0106274:	8b 55 b0             	mov    -0x50(%ebp),%edx
c0106277:	0f a3 10             	bt     %edx,(%eax)
c010627a:	19 c0                	sbb    %eax,%eax
c010627c:	89 45 a8             	mov    %eax,-0x58(%ebp)
    return oldbit != 0;
c010627f:	83 7d a8 00          	cmpl   $0x0,-0x58(%ebp)
c0106283:	0f 95 c0             	setne  %al
c0106286:	0f b6 c0             	movzbl %al,%eax
c0106289:	85 c0                	test   %eax,%eax
c010628b:	75 19                	jne    c01062a6 <check_swap+0x6b>
c010628d:	68 1a bd 10 c0       	push   $0xc010bd1a
c0106292:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106297:	68 b9 00 00 00       	push   $0xb9
c010629c:	68 b8 bb 10 c0       	push   $0xc010bbb8
c01062a1:	e8 c2 b4 ff ff       	call   c0101768 <__panic>
        count ++, total += p->property;
c01062a6:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
c01062aa:	8b 45 e0             	mov    -0x20(%ebp),%eax
c01062ad:	8b 50 08             	mov    0x8(%eax),%edx
c01062b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
c01062b3:	01 d0                	add    %edx,%eax
c01062b5:	89 45 f0             	mov    %eax,-0x10(%ebp)
c01062b8:	8b 45 e8             	mov    -0x18(%ebp),%eax
c01062bb:	89 45 dc             	mov    %eax,-0x24(%ebp)
 * list_next - get the next entry
 * @listelm:    the list head
 **/
static inline list_entry_t *
list_next(list_entry_t *listelm) {
    return listelm->next;
c01062be:	8b 45 dc             	mov    -0x24(%ebp),%eax
c01062c1:	8b 40 04             	mov    0x4(%eax),%eax
check_swap(void)
{
    //backup mem env
     int ret, count = 0, total = 0, i;
     list_entry_t *le = &free_list;
     while ((le = list_next(le)) != &free_list) {
c01062c4:	89 45 e8             	mov    %eax,-0x18(%ebp)
c01062c7:	81 7d e8 44 d1 12 c0 	cmpl   $0xc012d144,-0x18(%ebp)
c01062ce:	75 88                	jne    c0106258 <check_swap+0x1d>
        struct Page *p = le2page(le, page_link);
        assert(PageProperty(p));
        count ++, total += p->property;
     }
     assert(total == nr_free_pages());
c01062d0:	e8 e1 18 00 00       	call   c0107bb6 <nr_free_pages>
c01062d5:	89 c2                	mov    %eax,%edx
c01062d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
c01062da:	39 c2                	cmp    %eax,%edx
c01062dc:	74 19                	je     c01062f7 <check_swap+0xbc>
c01062de:	68 2a bd 10 c0       	push   $0xc010bd2a
c01062e3:	68 1e bc 10 c0       	push   $0xc010bc1e
c01062e8:	68 bc 00 00 00       	push   $0xbc
c01062ed:	68 b8 bb 10 c0       	push   $0xc010bbb8
c01062f2:	e8 71 b4 ff ff       	call   c0101768 <__panic>
     cprintf("BEGIN check_swap: count %d, total %d\n",count,total);
c01062f7:	83 ec 04             	sub    $0x4,%esp
c01062fa:	ff 75 f0             	pushl  -0x10(%ebp)
c01062fd:	ff 75 f4             	pushl  -0xc(%ebp)
c0106300:	68 44 bd 10 c0       	push   $0xc010bd44
c0106305:	e8 80 9f ff ff       	call   c010028a <cprintf>
c010630a:	83 c4 10             	add    $0x10,%esp
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
c010630d:	e8 7f e2 ff ff       	call   c0104591 <mm_create>
c0106312:	89 45 d8             	mov    %eax,-0x28(%ebp)
     assert(mm != NULL);
c0106315:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
c0106319:	75 19                	jne    c0106334 <check_swap+0xf9>
c010631b:	68 6a bd 10 c0       	push   $0xc010bd6a
c0106320:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106325:	68 c1 00 00 00       	push   $0xc1
c010632a:	68 b8 bb 10 c0       	push   $0xc010bbb8
c010632f:	e8 34 b4 ff ff       	call   c0101768 <__panic>

     extern struct mm_struct *check_mm_struct;
     assert(check_mm_struct == NULL);
c0106334:	a1 58 d0 12 c0       	mov    0xc012d058,%eax
c0106339:	85 c0                	test   %eax,%eax
c010633b:	74 19                	je     c0106356 <check_swap+0x11b>
c010633d:	68 75 bd 10 c0       	push   $0xc010bd75
c0106342:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106347:	68 c4 00 00 00       	push   $0xc4
c010634c:	68 b8 bb 10 c0       	push   $0xc010bbb8
c0106351:	e8 12 b4 ff ff       	call   c0101768 <__panic>

     check_mm_struct = mm;
c0106356:	8b 45 d8             	mov    -0x28(%ebp),%eax
c0106359:	a3 58 d0 12 c0       	mov    %eax,0xc012d058

     pde_t *pgdir = mm->pgdir = boot_pgdir;
c010635e:	8b 15 20 7a 12 c0    	mov    0xc0127a20,%edx
c0106364:	8b 45 d8             	mov    -0x28(%ebp),%eax
c0106367:	89 50 0c             	mov    %edx,0xc(%eax)
c010636a:	8b 45 d8             	mov    -0x28(%ebp),%eax
c010636d:	8b 40 0c             	mov    0xc(%eax),%eax
c0106370:	89 45 d4             	mov    %eax,-0x2c(%ebp)
     assert(pgdir[0] == 0);
c0106373:	8b 45 d4             	mov    -0x2c(%ebp),%eax
c0106376:	8b 00                	mov    (%eax),%eax
c0106378:	85 c0                	test   %eax,%eax
c010637a:	74 19                	je     c0106395 <check_swap+0x15a>
c010637c:	68 8d bd 10 c0       	push   $0xc010bd8d
c0106381:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106386:	68 c9 00 00 00       	push   $0xc9
c010638b:	68 b8 bb 10 c0       	push   $0xc010bbb8
c0106390:	e8 d3 b3 ff ff       	call   c0101768 <__panic>

     struct vma_struct *vma = vma_create(BEING_CHECK_VALID_VADDR, CHECK_VALID_VADDR, VM_WRITE | VM_READ);
c0106395:	83 ec 04             	sub    $0x4,%esp
c0106398:	6a 03                	push   $0x3
c010639a:	68 00 60 00 00       	push   $0x6000
c010639f:	68 00 10 00 00       	push   $0x1000
c01063a4:	e8 64 e2 ff ff       	call   c010460d <vma_create>
c01063a9:	83 c4 10             	add    $0x10,%esp
c01063ac:	89 45 d0             	mov    %eax,-0x30(%ebp)
     assert(vma != NULL);
c01063af:	83 7d d0 00          	cmpl   $0x0,-0x30(%ebp)
c01063b3:	75 19                	jne    c01063ce <check_swap+0x193>
c01063b5:	68 9b bd 10 c0       	push   $0xc010bd9b
c01063ba:	68 1e bc 10 c0       	push   $0xc010bc1e
c01063bf:	68 cc 00 00 00       	push   $0xcc
c01063c4:	68 b8 bb 10 c0       	push   $0xc010bbb8
c01063c9:	e8 9a b3 ff ff       	call   c0101768 <__panic>

     insert_vma_struct(mm, vma);
c01063ce:	83 ec 08             	sub    $0x8,%esp
c01063d1:	ff 75 d0             	pushl  -0x30(%ebp)
c01063d4:	ff 75 d8             	pushl  -0x28(%ebp)
c01063d7:	e8 99 e3 ff ff       	call   c0104775 <insert_vma_struct>
c01063dc:	83 c4 10             	add    $0x10,%esp

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
c01063df:	83 ec 0c             	sub    $0xc,%esp
c01063e2:	68 a8 bd 10 c0       	push   $0xc010bda8
c01063e7:	e8 9e 9e ff ff       	call   c010028a <cprintf>
c01063ec:	83 c4 10             	add    $0x10,%esp
     pte_t *temp_ptep=NULL;
c01063ef:	c7 45 cc 00 00 00 00 	movl   $0x0,-0x34(%ebp)
     temp_ptep = get_pte(mm->pgdir, BEING_CHECK_VALID_VADDR, 1);
c01063f6:	8b 45 d8             	mov    -0x28(%ebp),%eax
c01063f9:	8b 40 0c             	mov    0xc(%eax),%eax
c01063fc:	83 ec 04             	sub    $0x4,%esp
c01063ff:	6a 01                	push   $0x1
c0106401:	68 00 10 00 00       	push   $0x1000
c0106406:	50                   	push   %eax
c0106407:	e8 85 1d 00 00       	call   c0108191 <get_pte>
c010640c:	83 c4 10             	add    $0x10,%esp
c010640f:	89 45 cc             	mov    %eax,-0x34(%ebp)
     assert(temp_ptep!= NULL);
c0106412:	83 7d cc 00          	cmpl   $0x0,-0x34(%ebp)
c0106416:	75 19                	jne    c0106431 <check_swap+0x1f6>
c0106418:	68 dc bd 10 c0       	push   $0xc010bddc
c010641d:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106422:	68 d4 00 00 00       	push   $0xd4
c0106427:	68 b8 bb 10 c0       	push   $0xc010bbb8
c010642c:	e8 37 b3 ff ff       	call   c0101768 <__panic>
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
c0106431:	83 ec 0c             	sub    $0xc,%esp
c0106434:	68 f0 bd 10 c0       	push   $0xc010bdf0
c0106439:	e8 4c 9e ff ff       	call   c010028a <cprintf>
c010643e:	83 c4 10             	add    $0x10,%esp
     
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
c0106441:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
c0106448:	e9 90 00 00 00       	jmp    c01064dd <check_swap+0x2a2>
          check_rp[i] = alloc_page();
c010644d:	83 ec 0c             	sub    $0xc,%esp
c0106450:	6a 01                	push   $0x1
c0106452:	e8 be 16 00 00       	call   c0107b15 <alloc_pages>
c0106457:	83 c4 10             	add    $0x10,%esp
c010645a:	89 c2                	mov    %eax,%edx
c010645c:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010645f:	89 14 85 80 d0 12 c0 	mov    %edx,-0x3fed2f80(,%eax,4)
          assert(check_rp[i] != NULL );
c0106466:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0106469:	8b 04 85 80 d0 12 c0 	mov    -0x3fed2f80(,%eax,4),%eax
c0106470:	85 c0                	test   %eax,%eax
c0106472:	75 19                	jne    c010648d <check_swap+0x252>
c0106474:	68 14 be 10 c0       	push   $0xc010be14
c0106479:	68 1e bc 10 c0       	push   $0xc010bc1e
c010647e:	68 d9 00 00 00       	push   $0xd9
c0106483:	68 b8 bb 10 c0       	push   $0xc010bbb8
c0106488:	e8 db b2 ff ff       	call   c0101768 <__panic>
          assert(!PageProperty(check_rp[i]));
c010648d:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0106490:	8b 04 85 80 d0 12 c0 	mov    -0x3fed2f80(,%eax,4),%eax
c0106497:	83 c0 04             	add    $0x4,%eax
c010649a:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
c01064a1:	89 45 a4             	mov    %eax,-0x5c(%ebp)
 * @addr:   the address to count from
 * */
static inline bool
test_bit(int nr, volatile void *addr) {
    int oldbit;
    asm volatile ("btl %2, %1; sbbl %0,%0" : "=r" (oldbit) : "m" (*(volatile long *)addr), "Ir" (nr));
c01064a4:	8b 45 a4             	mov    -0x5c(%ebp),%eax
c01064a7:	8b 55 e4             	mov    -0x1c(%ebp),%edx
c01064aa:	0f a3 10             	bt     %edx,(%eax)
c01064ad:	19 c0                	sbb    %eax,%eax
c01064af:	89 45 a0             	mov    %eax,-0x60(%ebp)
    return oldbit != 0;
c01064b2:	83 7d a0 00          	cmpl   $0x0,-0x60(%ebp)
c01064b6:	0f 95 c0             	setne  %al
c01064b9:	0f b6 c0             	movzbl %al,%eax
c01064bc:	85 c0                	test   %eax,%eax
c01064be:	74 19                	je     c01064d9 <check_swap+0x29e>
c01064c0:	68 28 be 10 c0       	push   $0xc010be28
c01064c5:	68 1e bc 10 c0       	push   $0xc010bc1e
c01064ca:	68 da 00 00 00       	push   $0xda
c01064cf:	68 b8 bb 10 c0       	push   $0xc010bbb8
c01064d4:	e8 8f b2 ff ff       	call   c0101768 <__panic>
     pte_t *temp_ptep=NULL;
     temp_ptep = get_pte(mm->pgdir, BEING_CHECK_VALID_VADDR, 1);
     assert(temp_ptep!= NULL);
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
     ...
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
c01064d9:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
c01064dd:	83 7d ec 03          	cmpl   $0x3,-0x14(%ebp)
c01064e1:	0f 8e 66 ff ff ff    	jle    c010644d <check_swap+0x212>
          check_rp[i] = alloc_page();
          assert(check_rp[i] != NULL );
          assert(!PageProperty(check_rp[i]));
     }
     list_entry_t free_list_store = free_list;
c01064e7:	a1 44 d1 12 c0       	mov    0xc012d144,%eax
c01064ec:	8b 15 48 d1 12 c0    	mov    0xc012d148,%edx
c01064f2:	89 45 98             	mov    %eax,-0x68(%ebp)
c01064f5:	89 55 9c             	mov    %edx,-0x64(%ebp)
c01064f8:	c7 45 c0 44 d1 12 c0 	movl   $0xc012d144,-0x40(%ebp)
 * list_init - initialize a new entry
 * @elm:        new entry to be initialized
 * */
static inline void
list_init(list_entry_t *elm) {
    elm->prev = elm->next = elm;
c01064ff:	8b 45 c0             	mov    -0x40(%ebp),%eax
c0106502:	8b 55 c0             	mov    -0x40(%ebp),%edx
c0106505:	89 50 04             	mov    %edx,0x4(%eax)
c0106508:	8b 45 c0             	mov    -0x40(%ebp),%eax
c010650b:	8b 50 04             	mov    0x4(%eax),%edx
c010650e:	8b 45 c0             	mov    -0x40(%ebp),%eax
c0106511:	89 10                	mov    %edx,(%eax)
c0106513:	c7 45 c8 44 d1 12 c0 	movl   $0xc012d144,-0x38(%ebp)
...
c010651a:	8b 45 c8             	mov    -0x38(%ebp),%eax
c010651d:	8b 40 04             	mov    0x4(%eax),%eax
c0106520:	39 45 c8             	cmp    %eax,-0x38(%ebp)
c0106523:	0f 94 c0             	sete   %al
c0106526:	0f b6 c0             	movzbl %al,%eax
     list_init(&free_list);
     assert(list_empty(&free_list));
c0106529:	85 c0                	test   %eax,%eax
c010652b:	75 19                	jne    c0106546 <check_swap+0x30b>
c010652d:	68 43 be 10 c0       	push   $0xc010be43
c0106532:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106537:	68 de 00 00 00       	push   $0xde
c010653c:	68 b8 bb 10 c0       	push   $0xc010bbb8
c0106541:	e8 22 b2 ff ff       	call   c0101768 <__panic>
     
     //assert(alloc_page() == NULL);
     
     unsigned int nr_free_store = nr_free;
c0106546:	a1 4c d1 12 c0       	mov    0xc012d14c,%eax
c010654b:	89 45 bc             	mov    %eax,-0x44(%ebp)
     nr_free = 0;
c010654e:	c7 05 4c d1 12 c0 00 	movl   $0x0,0xc012d14c
c0106555:	00 00 00 
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
c0106558:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
c010655f:	eb 1c                	jmp    c010657d <check_swap+0x342>
        free_pages(check_rp[i],1);
c0106561:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0106564:	8b 04 85 80 d0 12 c0 	mov    -0x3fed2f80(,%eax,4),%eax
c010656b:	83 ec 08             	sub    $0x8,%esp
c010656e:	6a 01                	push   $0x1
c0106570:	50                   	push   %eax
c0106571:	e8 0b 16 00 00       	call   c0107b81 <free_pages>
c0106576:	83 c4 10             	add    $0x10,%esp
     ...
     nr_free = 0;
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
c0106579:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
c010657d:	83 7d ec 03          	cmpl   $0x3,-0x14(%ebp)
c0106581:	7e de                	jle    c0106561 <check_swap+0x326>
        free_pages(check_rp[i],1);
     }
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
c0106583:	a1 4c d1 12 c0       	mov    0xc012d14c,%eax
c0106588:	83 f8 04             	cmp    $0x4,%eax
c010658b:	74 19                	je     c01065a6 <check_swap+0x36b>
c010658d:	68 5c be 10 c0       	push   $0xc010be5c
c0106592:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106597:	68 e7 00 00 00       	push   $0xe7
c010659c:	68 b8 bb 10 c0       	push   $0xc010bbb8
c01065a1:	e8 c2 b1 ff ff       	call   c0101768 <__panic>
     
     cprintf("set up init env for check_swap begin!\n");
c01065a6:	83 ec 0c             	sub    $0xc,%esp
c01065a9:	68 80 be 10 c0       	push   $0xc010be80
c01065ae:	e8 d7 9c ff ff       	call   c010028a <cprintf>
c01065b3:	83 c4 10             	add    $0x10,%esp
     //setup initial vir_page<->phy_page environment for page relpacement algorithm 

     
     pgfault_num=0;
c01065b6:	c7 05 64 af 12 c0 00 	movl   $0x0,0xc012af64
c01065bd:	00 00 00 
     
     check_content_set();
c01065c0:	e8 fd fa ff ff       	call   c01060c2 <check_content_set>
     assert( nr_free == 0);         
c01065c5:	a1 4c d1 12 c0       	mov    0xc012d14c,%eax
c01065ca:	85 c0                	test   %eax,%eax
c01065cc:	74 19                	je     c01065e7 <check_swap+0x3ac>
c01065ce:	68 a7 be 10 c0       	push   $0xc010bea7
c01065d3:	68 1e bc 10 c0       	push   $0xc010bc1e
c01065d8:	68 f0 00 00 00       	push   $0xf0
c01065dd:	68 b8 bb 10 c0       	push   $0xc010bbb8
c01065e2:	e8 81 b1 ff ff       	call   c0101768 <__panic>
     for(i = 0; i<MAX_SEQ_NO ; i++) 
c01065e7:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
c01065ee:	eb 26                	jmp    c0106616 <check_swap+0x3db>
         swap_out_seq_no[i]=swap_in_seq_no[i]=-1;
c01065f0:	8b 45 ec             	mov    -0x14(%ebp),%eax
c01065f3:	c7 04 85 a0 d0 12 c0 	movl   $0xffffffff,-0x3fed2f60(,%eax,4)
c01065fa:	ff ff ff ff 
c01065fe:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0106601:	8b 14 85 a0 d0 12 c0 	mov    -0x3fed2f60(,%eax,4),%edx
c0106608:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010660b:	89 14 85 e0 d0 12 c0 	mov    %edx,-0x3fed2f20(,%eax,4)
     ...
     assert( nr_free == 0);         
     for(i = 0; i<MAX_SEQ_NO ; i++) 
c0106612:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
c0106616:	83 7d ec 09          	cmpl   $0x9,-0x14(%ebp)
c010661a:	7e d4                	jle    c01065f0 <check_swap+0x3b5>
         swap_out_seq_no[i]=swap_in_seq_no[i]=-1;
     
     for (i= 0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
c010661c:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
c0106623:	e9 cc 00 00 00       	jmp    c01066f4 <check_swap+0x4b9>
         check_ptep[i]=0;
c0106628:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010662b:	c7 04 85 34 d1 12 c0 	movl   $0x0,-0x3fed2ecc(,%eax,4)
c0106632:	00 00 00 00 
         check_ptep[i] = get_pte(pgdir, (i+1)*0x1000, 0);
c0106636:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0106639:	83 c0 01             	add    $0x1,%eax
c010663c:	c1 e0 0c             	shl    $0xc,%eax
c010663f:	83 ec 04             	sub    $0x4,%esp
c0106642:	6a 00                	push   $0x0
c0106644:	50                   	push   %eax
c0106645:	ff 75 d4             	pushl  -0x2c(%ebp)
c0106648:	e8 44 1b 00 00       	call   c0108191 <get_pte>
c010664d:	83 c4 10             	add    $0x10,%esp
c0106650:	89 c2                	mov    %eax,%edx
c0106652:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0106655:	89 14 85 34 d1 12 c0 	mov    %edx,-0x3fed2ecc(,%eax,4)
         //cprintf("i %d, check_ptep addr %x, value %x\n", i, check_ptep[i], *check_ptep[i]);
         assert(check_ptep[i] != NULL);
c010665c:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010665f:	8b 04 85 34 d1 12 c0 	mov    -0x3fed2ecc(,%eax,4),%eax
c0106666:	85 c0                	test   %eax,%eax
c0106668:	75 19                	jne    c0106683 <check_swap+0x448>
c010666a:	68 b4 be 10 c0       	push   $0xc010beb4
c010666f:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106674:	68 f8 00 00 00       	push   $0xf8
c0106679:	68 b8 bb 10 c0       	push   $0xc010bbb8
c010667e:	e8 e5 b0 ff ff       	call   c0101768 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
c0106683:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0106686:	8b 04 85 34 d1 12 c0 	mov    -0x3fed2ecc(,%eax,4),%eax
c010668d:	8b 00                	mov    (%eax),%eax
c010668f:	83 ec 0c             	sub    $0xc,%esp
c0106692:	50                   	push   %eax
c0106693:	e8 f4 f6 ff ff       	call   c0105d8c <pte2page>
c0106698:	83 c4 10             	add    $0x10,%esp
c010669b:	89 c2                	mov    %eax,%edx
c010669d:	8b 45 ec             	mov    -0x14(%ebp),%eax
c01066a0:	8b 04 85 80 d0 12 c0 	mov    -0x3fed2f80(,%eax,4),%eax
c01066a7:	39 c2                	cmp    %eax,%edx
c01066a9:	74 19                	je     c01066c4 <check_swap+0x489>
c01066ab:	68 cc be 10 c0       	push   $0xc010becc
c01066b0:	68 1e bc 10 c0       	push   $0xc010bc1e
c01066b5:	68 f9 00 00 00       	push   $0xf9
c01066ba:	68 b8 bb 10 c0       	push   $0xc010bbb8
c01066bf:	e8 a4 b0 ff ff       	call   c0101768 <__panic>
         assert((*check_ptep[i] & PTE_P));          
c01066c4:	8b 45 ec             	mov    -0x14(%ebp),%eax
c01066c7:	8b 04 85 34 d1 12 c0 	mov    -0x3fed2ecc(,%eax,4),%eax
c01066ce:	8b 00                	mov    (%eax),%eax
c01066d0:	83 e0 01             	and    $0x1,%eax
c01066d3:	85 c0                	test   %eax,%eax
c01066d5:	75 19                	jne    c01066f0 <check_swap+0x4b5>
c01066d7:	68 f4 be 10 c0       	push   $0xc010bef4
c01066dc:	68 1e bc 10 c0       	push   $0xc010bc1e
c01066e1:	68 fa 00 00 00       	push   $0xfa
c01066e6:	68 b8 bb 10 c0       	push   $0xc010bbb8
c01066eb:	e8 78 b0 ff ff       	call   c0101768 <__panic>
     check_content_set();
     assert( nr_free == 0);         
     for(i = 0; i<MAX_SEQ_NO ; i++) 
         swap_out_seq_no[i]=swap_in_seq_no[i]=-1;
     ...
     for (i= 0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
c01066f0:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
c01066f4:	83 7d ec 03          	cmpl   $0x3,-0x14(%ebp)
c01066f8:	0f 8e 2a ff ff ff    	jle    c0106628 <check_swap+0x3ed>
         //cprintf("i %d, check_ptep addr %x, value %x\n", i, check_ptep[i], *check_ptep[i]);
         assert(check_ptep[i] != NULL);
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
         assert((*check_ptep[i] & PTE_P));          
...
c0106701:	68 10 bf 10 c0       	push   $0xc010bf10
c0106706:	e8 7f 9b ff ff       	call   c010028a <cprintf>
c010670b:	83 c4 10             	add    $0x10,%esp
     // now access the virt pages to test  page relpacement algorithm 
     ret=check_content_access();
c010670e:	e8 10 fb ff ff       	call   c0106223 <check_content_access>
c0106713:	89 45 b8             	mov    %eax,-0x48(%ebp)
     assert(ret==0);
c0106716:	83 7d b8 00          	cmpl   $0x0,-0x48(%ebp)
c010671a:	74 19                	je     c0106735 <check_swap+0x4fa>
c010671c:	68 36 bf 10 c0       	push   $0xc010bf36
c0106721:	68 1e bc 10 c0       	push   $0xc010bc1e
c0106726:	68 ff 00 00 00       	push   $0xff
c010672b:	68 b8 bb 10 c0       	push   $0xc010bbb8
c0106730:	e8 33 b0 ff ff       	call   c0101768 <__panic>
     
     //restore kernel mem env
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
c0106735:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
c010673c:	eb 1c                	jmp    c010675a <check_swap+0x51f>
         free_pages(check_rp[i],1);
c010673e:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0106741:	8b 04 85 80 d0 12 c0 	mov    -0x3fed2f80(,%eax,4),%eax
c0106748:	83 ec 08             	sub    $0x8,%esp
c010674b:	6a 01                	push   $0x1
c010674d:	50                   	push   %eax
c010674e:	e8 2e 14 00 00       	call   c0107b81 <free_pages>
c0106753:	83 c4 10             	add    $0x10,%esp
     // now access the virt pages to test  page relpacement algorithm 
     ret=check_content_access();
     assert(ret==0);
     ...
     //restore kernel mem env
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
c0106756:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
c010675a:	83 7d ec 03          	cmpl   $0x3,-0x14(%ebp)
c010675e:	7e de                	jle    c010673e <check_swap+0x503>
         free_pages(check_rp[i],1);
     } 
     ...
     mm_destroy(mm);
c0106760:	83 ec 0c             	sub    $0xc,%esp
c0106763:	ff 75 d8             	pushl  -0x28(%ebp)
c0106766:	e8 2e e1 ff ff       	call   c0104899 <mm_destroy>
c010676b:	83 c4 10             	add    $0x10,%esp
         
     nr_free = nr_free_store;
c010676e:	8b 45 bc             	mov    -0x44(%ebp),%eax
c0106771:	a3 4c d1 12 c0       	mov    %eax,0xc012d14c
     free_list = free_list_store;
c0106776:	8b 45 98             	mov    -0x68(%ebp),%eax
c0106779:	8b 55 9c             	mov    -0x64(%ebp),%edx
c010677c:	a3 44 d1 12 c0       	mov    %eax,0xc012d144
c0106781:	89 15 48 d1 12 c0    	mov    %edx,0xc012d148

     
     le = &free_list;
c0106787:	c7 45 e8 44 d1 12 c0 	movl   $0xc012d144,-0x18(%ebp)
     while ((le = list_next(le)) != &free_list) {
c010678e:	eb 1d                	jmp    c01067ad <check_swap+0x572>
         struct Page *p = le2page(le, page_link);
c0106790:	8b 45 e8             	mov    -0x18(%ebp),%eax
c0106793:	83 e8 10             	sub    $0x10,%eax
c0106796:	89 45 b4             	mov    %eax,-0x4c(%ebp)
         count --, total -= p->property;
c0106799:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
c010679d:	8b 55 f0             	mov    -0x10(%ebp),%edx
c01067a0:	8b 45 b4             	mov    -0x4c(%ebp),%eax
c01067a3:	8b 40 08             	mov    0x8(%eax),%eax
c01067a6:	29 c2                	sub    %eax,%edx
c01067a8:	89 d0                	mov    %edx,%eax
c01067aa:	89 45 f0             	mov    %eax,-0x10(%ebp)
c01067ad:	8b 45 e8             	mov    -0x18(%ebp),%eax
c01067b0:	89 45 c4             	mov    %eax,-0x3c(%ebp)
 * list_next - get the next entry
 * @listelm:    the list head
 **/
static inline list_entry_t *
list_next(list_entry_t *listelm) {
    return listelm->next;
c01067b3:	8b 45 c4             	mov    -0x3c(%ebp),%eax
c01067b6:	8b 40 04             	mov    0x4(%eax),%eax
     nr_free = nr_free_store;
     free_list = free_list_store;
     ...
     le = &free_list;
     while ((le = list_next(le)) != &free_list) {
c01067b9:	89 45 e8             	mov    %eax,-0x18(%ebp)
c01067bc:	81 7d e8 44 d1 12 c0 	cmpl   $0xc012d144,-0x18(%ebp)
c01067c3:	75 cb                	jne    c0106790 <check_swap+0x555>
         struct Page *p = le2page(le, page_link);
         count --, total -= p->property;
     }
...
c01067cb:	ff 75 f4             	pushl  -0xc(%ebp)
c01067ce:	68 3d bf 10 c0       	push   $0xc010bf3d
c01067d3:	e8 b2 9a ff ff       	call   c010028a <cprintf>
c01067d8:	83 c4 10             	add    $0x10,%esp
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
c01067db:	83 ec 0c             	sub    $0xc,%esp
c01067de:	68 57 bf 10 c0       	push   $0xc010bf57
c01067e3:	e8 a2 9a ff ff       	call   c010028a <cprintf>
...
c01067f4:	8b 15 58 d1 12 c0    	mov    0xc012d158,%edx
...
c0106838:	c7 45 fc 44 d1 12 c0 	movl   $0xc012d144,-0x4(%ebp)
 * list_init - initialize a new entry
 * @elm:        new entry to be initialized
 * */
static inline void
...
c0106851:	89 10                	mov    %edx,(%eax)
    list_init(&free_list);
    nr_free = 0;
c0106853:	c7 05 4c d1 12 c0 00 	movl   $0x0,0xc012d14c
c010685a:	00 00 00 
}
c010685d:	90                   	nop
c010685e:	c9                   	leave  
...
c0106932:	0f ab 10             	bts    %edx,(%eax)
    nr_free += n;
c0106935:	8b 15 4c d1 12 c0    	mov    0xc012d14c,%edx
c010693b:	8b 45 0c             	mov    0xc(%ebp),%eax
c010693e:	01 d0                	add    %edx,%eax
c0106940:	a3 4c d1 12 c0       	mov    %eax,0xc012d14c
    list_add_before(&free_list, &(base->page_link));
c0106945:	8b 45 08             	mov    0x8(%ebp),%eax
c0106948:	83 c0 10             	add    $0x10,%eax
c010694b:	c7 45 f0 44 d1 12 c0 	movl   $0xc012d144,-0x10(%ebp)
...
c01069ad:	e8 b6 ad ff ff       	call   c0101768 <__panic>
    if (n > nr_free) {
c01069b2:	a1 4c d1 12 c0       	mov    0xc012d14c,%eax
...
c01069c6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    list_entry_t *le = &free_list;
c01069cd:	c7 45 f0 44 d1 12 c0 	movl   $0xc012d144,-0x10(%ebp)
...
c0106a01:	81 7d f0 44 d1 12 c0 	cmpl   $0xc012d144,-0x10(%ebp)
...
c0106ad8:	89 10                	mov    %edx,(%eax)
        nr_free -= n;
c0106ada:	a1 4c d1 12 c0       	mov    0xc012d14c,%eax
c0106adf:	2b 45 08             	sub    0x8(%ebp),%eax
c0106ae2:	a3 4c d1 12 c0       	mov    %eax,0xc012d14c
...
c0106c06:	c7 45 e8 44 d1 12 c0 	movl   $0xc012d144,-0x18(%ebp)
 * list_next - get the next entry
 * @listelm:    the list head
 **/
static inline list_entry_t *
...
c0106d21:	89 10                	mov    %edx,(%eax)
    ...
    list_entry_t *le = list_next(&free_list);
    while (le != &free_list) {
c0106d23:	81 7d f0 44 d1 12 c0 	cmpl   $0xc012d144,-0x10(%ebp)
c0106d2a:	0f 85 eb fe ff ff    	jne    c0106c1b <default_free_pages+0x116>
    ...
    nr_free += n;
c0106d30:	8b 15 4c d1 12 c0    	mov    0xc012d14c,%edx
c0106d36:	8b 45 0c             	mov    0xc(%ebp),%eax
c0106d39:	01 d0                	add    %edx,%eax
c0106d3b:	a3 4c d1 12 c0       	mov    %eax,0xc012d14c
c0106d40:	c7 45 d0 44 d1 12 c0 	movl   $0xc012d144,-0x30(%ebp)
 * list_next - get the next entry
 * @listelm:    the list head
 **/
static inline list_entry_t *
...
c0106db8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    le = list_next(&free_list);
    while (le != &free_list) {
c0106dbb:	81 7d f0 44 d1 12 c0 	cmpl   $0xc012d144,-0x10(%ebp)
...
c0106e12:	89 e5                	mov    %esp,%ebp
    return nr_free;
c0106e14:	a1 4c d1 12 c0       	mov    0xc012d14c,%eax
}
c0106e19:	5d                   	pop    %ebp
c0106e1a:	c3                   	ret    
...
c0106fdb:	e8 88 a7 ff ff       	call   c0101768 <__panic>
    ...
    list_entry_t free_list_store = free_list;
c0106fe0:	a1 44 d1 12 c0       	mov    0xc012d144,%eax
c0106fe5:	8b 15 48 d1 12 c0    	mov    0xc012d148,%edx
c0106feb:	89 45 d0             	mov    %eax,-0x30(%ebp)
c0106fee:	89 55 d4             	mov    %edx,-0x2c(%ebp)
c0106ff1:	c7 45 e4 44 d1 12 c0 	movl   $0xc012d144,-0x1c(%ebp)
 * list_init - initialize a new entry
 * @elm:        new entry to be initialized
 * */
static inline void
...
c010700c:	c7 45 d8 44 d1 12 c0 	movl   $0xc012d144,-0x28(%ebp)
 * list_empty - tests whether a list is empty
 * @list:       the list to test.
 * */
static inline bool
...
c010703a:	e8 29 a7 ff ff       	call   c0101768 <__panic>
    ...
    unsigned int nr_free_store = nr_free;
c010703f:	a1 4c d1 12 c0       	mov    0xc012d14c,%eax
c0107044:	89 45 e0             	mov    %eax,-0x20(%ebp)
    nr_free = 0;
c0107047:	c7 05 4c d1 12 c0 00 	movl   $0x0,0xc012d14c
c010704e:	00 00 00 
...
c01070a8:	83 c4 10             	add    $0x10,%esp
    assert(nr_free == 3);
c01070ab:	a1 4c d1 12 c0       	mov    0xc012d14c,%eax
...
c0107195:	c7 45 e8 44 d1 12 c0 	movl   $0xc012d144,-0x18(%ebp)
...
c010721e:	e8 45 a5 ff ff       	call   c0101768 <__panic>
    ...
    assert(nr_free == 0);
c0107223:	a1 4c d1 12 c0       	mov    0xc012d14c,%eax
...
c010724b:	a3 44 d1 12 c0       	mov    %eax,0xc012d144
c0107250:	89 15 48 d1 12 c0    	mov    %edx,0xc012d148
    nr_free = nr_free_store;
c0107256:	8b 45 e0             	mov    -0x20(%ebp),%eax
c0107259:	a3 4c d1 12 c0       	mov    %eax,0xc012d14c
...
c01072a1:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    list_entry_t *le = &free_list;
c01072a8:	c7 45 ec 44 d1 12 c0 	movl   $0xc012d144,-0x14(%ebp)
    while ((le = list_next(le)) != &free_list) {
...
c0107320:	81 7d ec 44 d1 12 c0 	cmpl   $0xc012d144,-0x14(%ebp)
...
c01073c4:	e8 9f a3 ff ff       	call   c0101768 <__panic>
    ...
    list_entry_t free_list_store = free_list;
c01073c9:	a1 44 d1 12 c0       	mov    0xc012d144,%eax
c01073ce:	8b 15 48 d1 12 c0    	mov    0xc012d148,%edx
c01073d4:	89 45 80             	mov    %eax,-0x80(%ebp)
c01073d7:	89 55 84             	mov    %edx,-0x7c(%ebp)
c01073da:	c7 45 d0 44 d1 12 c0 	movl   $0xc012d144,-0x30(%ebp)
 * list_init - initialize a new entry
 * @elm:        new entry to be initialized
 * */
static inline void
...
c01073f5:	c7 45 d8 44 d1 12 c0 	movl   $0xc012d144,-0x28(%ebp)
 * list_empty - tests whether a list is empty
 * @list:       the list to test.
 * */
static inline bool
...
c010744d:	e8 16 a3 ff ff       	call   c0101768 <__panic>
    ...
    unsigned int nr_free_store = nr_free;
c0107452:	a1 4c d1 12 c0       	mov    0xc012d14c,%eax
c0107457:	89 45 cc             	mov    %eax,-0x34(%ebp)
    nr_free = 0;
c010745a:	c7 05 4c d1 12 c0 00 	movl   $0x0,0xc012d14c
c0107461:	00 00 00 
...
c010772a:	e8 39 a0 ff ff       	call   c0101768 <__panic>
    ...
    assert(nr_free == 0);
c010772f:	a1 4c d1 12 c0       	mov    0xc012d14c,%eax
...
c0107754:	a3 4c d1 12 c0       	mov    %eax,0xc012d14c

    free_list = free_list_store;
c0107759:	8b 45 80             	mov    -0x80(%ebp),%eax
c010775c:	8b 55 84             	mov    -0x7c(%ebp),%edx
c010775f:	a3 44 d1 12 c0       	mov    %eax,0xc012d144
c0107764:	89 15 48 d1 12 c0    	mov    %edx,0xc012d148
    free_pages(p0, 5);
...
c0107777:	83 c4 10             	add    $0x10,%esp
    ...
    le = &free_list;
c010777a:	c7 45 ec 44 d1 12 c0 	movl   $0xc012d144,-0x14(%ebp)
    while ((le = list_next(le)) != &free_list) {
...
c01077af:	81 7d ec 44 d1 12 c0 	cmpl   $0xc012d144,-0x14(%ebp)
...
c01077ff:	8b 15 58 d1 12 c0    	mov    0xc012d158,%edx
...
c010784b:	e8 18 9f ff ff       	call   c0101768 <__panic>
    ...
    return &pages[PPN(pa)];
c0107850:	8b 0d 58 d1 12 c0    	mov    0xc012d158,%ecx
...
c0107ac7:	c7 05 50 d1 12 c0 00 	movl   $0xc010c300,0xc012d150
c0107ace:	c3 10 c0 
    cprintf("memory management: %s\n", pmm_manager->name);
c0107ad1:	a1 50 d1 12 c0       	mov    0xc012d150,%eax
...
c0107ae6:	83 c4 10             	add    $0x10,%esp
    pmm_manager->init();
c0107ae9:	a1 50 d1 12 c0       	mov    0xc012d150,%eax
...
c0107afc:	a1 50 d1 12 c0       	mov    0xc012d150,%eax
...
c0107b2a:	a1 50 d1 12 c0       	mov    0xc012d150,%eax
...
c0107b5a:	a1 6c af 12 c0       	mov    0xc012af6c,%eax
...
c0107b72:	e8 47 e3 ff ff       	call   c0105ebe <swap_out>
...
c0107b8f:	a1 50 d1 12 c0       	mov    0xc012d150,%eax
...
c0107bc4:	a1 50 d1 12 c0       	mov    0xc012d150,%eax
...
c0107d64:	b8 64 d1 12 c0       	mov    $0xc012d164,%eax
...
c0107ddf:	a1 58 d1 12 c0       	mov    0xc012d158,%eax
...
c0108102:	a3 54 d1 12 c0       	mov    %eax,0xc012d154
...
c0108184:	e8 4e 0d 00 00       	call   c0108ed7 <print_pgdir>
    ...
    kmalloc_init();
c0108189:	e8 0c d9 ff ff       	call   c0105a9a <kmalloc_init>
...
c01084f8:	eb 57                	jmp    c0108551 <pgdir_alloc_page+0xa6>
        ...
        if (swap_init_ok){
c01084fa:	a1 6c af 12 c0       	mov    0xc012af6c,%eax
...
c0108511:	e8 69 d9 ff ff       	call   c0105e7f <swap_map_swappable>
...
c0108556:	83 ec 08             	sub    $0x8,%esp
    pmm_manager->check();
c0108559:	a1 50 d1 12 c0       	mov    0xc012d150,%eax
...
c0109031:	8b 15 58 d1 12 c0    	mov    0xc012d158,%edx
...
c01090d7:	a3 1c d1 12 c0       	mov    %eax,0xc012d11c
}
c01090dc:	90                   	nop
c01090dd:	c9                   	leave  
c01090de:	c3                   	ret    
...
c0109104:	a1 1c d1 12 c0       	mov    0xc012d11c,%eax
...
c010915d:	a1 1c d1 12 c0       	mov    0xc012d11c,%eax
...
c0109215:	8b 15 58 d1 12 c0    	mov    0xc012d158,%edx
...
c0109261:	e8 02 85 ff ff       	call   c0101768 <__panic>
    ...
    return &pages[PPN(pa)];
c0109266:	8b 0d 58 d1 12 c0    	mov    0xc012d158,%ecx
...
c0109311:	e8 c9 c8 ff ff       	call   c0105bdf <kmalloc>
...
c0109384:	c7 40 3c 00 00 00 00 	movl   $0x0,0x3c(%eax)
        proc->cr3 = boot_cr3;
c010938b:	8b 15 54 d1 12 c0    	mov    0xc012d154,%edx
...
c010942c:	c7 45 f8 5c d1 12 c0 	movl   $0xc012d15c,-0x8(%ebp)
...
c01098ed:	c7 45 e8 5c d1 12 c0 	movl   $0xc012d15c,-0x18(%ebp)
...
c0109991:	e8 61 c2 ff ff       	call   c0105bf7 <kfree>
...
c0109a1d:	c7 45 e8 5c d1 12 c0 	movl   $0xc012d15c,-0x18(%ebp)
 * list_init - initialize a new entry
 * @elm:        new entry to be initialized
 * */
static inline void
...
c0109c84:	b8 5c d1 12 c0       	mov    $0xc012d15c,%eax
...
c0109ca1:	81 7d f4 5c d1 12 c0 	cmpl   $0xc012d15c,-0xc(%ebp)
